...
HX_STACK_FRAME("snow.Snow","new",0x2ec45060,"snow.Snow.new","snow/Snow.hx",24,0x86524d2f)
{
	...
	this->freeze = false;
	HX_STACK_LINE(78)
	::snow::Snow_obj::core = ::snow::platform::native::Core_obj::__new(hx::ObjectPtr<OBJ_>(this));
	HX_STACK_LINE(79)
...
Void Snow_obj::init( Dynamic _snow_config,::snow::App _host){
{
		...
		HX_STACK_LINE(95)
		Dynamic _g2 = _Function_1_2::Block();		HX_STACK_VAR(_g2,"_g2");
		struct _Function_1_3{
			inline static Dynamic Block( Dynamic &_g1,Dynamic &_g,Dynamic &_g2){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","snow/Snow.hx",89,0x86524d2f)
				{
					hx::Anon __result = hx::Anon_obj::Create();
					__result->Add(HX_CSTRING("has_window") , true,false);
					__result->Add(HX_CSTRING("runtime") , _g,false);
					__result->Add(HX_CSTRING("window") , null(),false);
					__result->Add(HX_CSTRING("render") , null(),false);
					__result->Add(HX_CSTRING("assets") , _g1,false);
					__result->Add(HX_CSTRING("web") , _g2,false);
					...
					__result->Add(HX_CSTRING("native") , _Function_2_1::Block(),false);
					return __result;
				}
				return null();
			}
		...
		HX_STACK_LINE(89)
		this->config = _Function_1_3::Block(_g1,_g,_g2);
		HX_STACK_LINE(105)
		this->host = _host;
		HX_STACK_LINE(106)
...
Void Snow_obj::on_snow_ready( ){
{
		...
		HX_STACK_LINE(175)
		this->io = ::snow::io::IO_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(176)
		this->input = ::snow::input::Input_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(177)
		this->audio = ::snow::audio::Audio_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(178)
		this->assets = ::snow::assets::Assets_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(179)
		this->windowing = ::snow::window::Windowing_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(182)
		if ((!(this->snow_config->__Field(HX_CSTRING("config_custom_assets"),true)))){
			...
			HX_STACK_LINE(191)
			this->config->__FieldRef(HX_CSTRING("assets")) = this->default_asset_list();
			HX_STACK_LINE(193)
		...
		if ((!(this->snow_config->__Field(HX_CSTRING("config_custom_runtime"),true)))){
			HX_STACK_LINE(199)
			this->config->__FieldRef(HX_CSTRING("runtime")) = this->default_runtime_config();
		}
		HX_STACK_LINE(202)
		this->config->__FieldRef(HX_CSTRING("window")) = this->default_window_config();
		HX_STACK_LINE(203)
		this->config->__FieldRef(HX_CSTRING("render")) = this->default_render_config();
		HX_STACK_LINE(208)
		...
		if (((this->config->__Field(HX_CSTRING("has_window"),true) == true))){
			HX_STACK_LINE(218)
			this->window = this->windowing->create(this->config->__Field(HX_CSTRING("window"),true));
			HX_STACK_LINE(221)
		...
		HX_STACK_LINE(403)
		{
			...
			while(((_g < _list->length))){
				...
				struct _Function_4_1{
					inline static Dynamic Block( ::String &_g1,::String &_g11,::String &asset){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","snow/Snow.hx",405,0x86524d2f)
						{
							...
							__result->Add(HX_CSTRING("ext") , ::haxe::io::Path_obj::extension(asset),false);
							return __result;
						}
						return null();
					}
				...
				HX_STACK_LINE(405)
				asset_list->__Field(HX_CSTRING("push"),true)(_Function_4_1::Block(_g1,_g11,asset));
			}
		}
		HX_STACK_LINE(136)
		Dynamic();
