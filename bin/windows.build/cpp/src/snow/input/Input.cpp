...
HX_STACK_ARG(_lib,"_lib")
{
	...
	this->lib = _lib;
	HX_STACK_LINE(46)
	this->platform = ::snow::platform::native::input::sdl::InputSystem_obj::__new(hx::ObjectPtr<OBJ_>(this),this->lib);
	HX_STACK_LINE(48)
	this->platform->init();
	HX_STACK_LINE(52)
	this->key_code_pressed = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(53)
	this->key_code_down = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(54)
	this->key_code_released = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(56)
	this->scan_code_pressed = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(57)
	this->scan_code_down = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(58)
	this->scan_code_released = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(61)
	this->mouse_button_pressed = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(62)
	this->mouse_button_down = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(63)
	this->mouse_button_released = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(66)
	this->gamepad_button_pressed = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(67)
	this->gamepad_button_down = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(68)
	this->gamepad_button_released = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(69)
	this->gamepad_axis_values = ::haxe::ds::IntMap_obj::__new();
}
;
	return null();
}
