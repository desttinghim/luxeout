...
HX_STACK_ARG(_lib,"_lib")
{
	...
	this->lib = _lib;
	HX_STACK_LINE(41)
	this->platform = ::snow::platform::native::audio::openal::AudioSystem_obj::__new(hx::ObjectPtr<OBJ_>(this),this->lib);
	HX_STACK_LINE(43)
	this->platform->init();
	HX_STACK_LINE(45)
	this->sound_list = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(46)
	this->stream_list = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(47)
	this->handles = ::snow::audio::_Audio::AudioHandleMap_obj::__new();
	HX_STACK_LINE(49)
	this->active = true;
}
;
	...
	HX_STACK_ARG(streaming,"streaming")
{
		...
		if ((!(streaming))){
			HX_STACK_LINE(86)
			sound[(int)0] = ::snow::platform::native::audio::openal::Sound_obj::__new(hx::ObjectPtr<OBJ_>(this),_name);
		}
		else{
			HX_STACK_LINE(90)
