...
Void Window_obj::on_window_created( Dynamic _handle,int _id,Dynamic _configs){
{
		...
		HX_STACK_LINE(122)
		this->on_event(_Function_1_1::Block(_g,_id));
		HX_STACK_LINE(136)
		Dynamic();
	}
return null();
...
Dynamic Window_obj::set_max_size( Dynamic _size){
	...
	HX_STACK_LINE(447)
	if (((  (((this->get_max_size() != null()))) ? bool((this->handle != null())) : bool(false) ))){
		HX_STACK_LINE(448)
...
Dynamic Window_obj::set_min_size( Dynamic _size){
	...
	HX_STACK_ARG(_size,"_size")
	HX_STACK_LINE(457)
	if (((  (((this->get_min_size() != null()))) ? bool((this->handle != null())) : bool(false) ))){
		HX_STACK_LINE(458)
