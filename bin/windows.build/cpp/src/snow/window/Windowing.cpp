...
HX_STACK_ARG(_lib,"_lib")
{
	...
	this->lib = _lib;
	HX_STACK_LINE(31)
	this->window_list = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(32)
	this->window_handles = ::snow::window::_Windowing::WindowHandleMap_obj::__new();
	HX_STACK_LINE(34)
	this->platform = ::snow::platform::native::window::sdl::WindowSystem_obj::__new(hx::ObjectPtr<OBJ_>(this),this->lib);
	HX_STACK_LINE(36)
	this->platform->init();
}
;
