...
Void GL_obj::bufferData( int target,::snow::utils::IMemoryRange data,int usage){
{
		...
		HX_STACK_LINE(688)
		::snow::platform::native::render::opengl::GL_obj::snow_gl_buffer_data(target,_g,_g1,data->getLength(),usage);
	}
return null();
}
...
Void GL_obj::bufferSubData( int target,int offset,::snow::utils::IMemoryRange data){
{
		...
		int _g1 = data->getStart();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(693)
		::snow::platform::native::render::opengl::GL_obj::snow_gl_buffer_sub_data(target,offset,_g,_g1,data->getLength());
	}
return null();
}
...
Void GL_obj::compressedTexImage2D( int target,int level,int internalformat,int width,int height,int border,::snow::utils::IMemoryRange data){
{
		...
		HX_STACK_LINE(733)
		::snow::platform::native::render::opengl::GL_obj::snow_gl_compressed_tex_image_2d(target,level,internalformat,width,height,border,_g,(  (((data == null()))) ? Dynamic(null()) : Dynamic(data->getStart()) ));
	}
return null();
}
...
Void GL_obj::compressedTexSubImage2D( int target,int level,int xoffset,int yoffset,int width,int height,int format,::snow::utils::IMemoryRange data){
{
		...
		HX_STACK_LINE(738)
		::snow::platform::native::render::opengl::GL_obj::snow_gl_compressed_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,_g,(  (((data == null()))) ? Dynamic(null()) : Dynamic(data->getStart()) ));
	}
return null();
}
...
::snow::platform::native::render::opengl::GLBuffer GL_obj::createBuffer( ){
	HX_STACK_FRAME("snow.platform.native.render.opengl.GL","createBuffer",0x6b425277,"snow.platform.native.render.opengl.GL.createBuffer","snow/platform/native/render/opengl/GL.hx",753,0x9056cf0a)
	HX_STACK_LINE(753)
	return ::snow::platform::native::render::opengl::GLBuffer_obj::__new(::snow::platform::native::render::opengl::GL_obj::snow_gl_create_buffer());
}
...
::snow::platform::native::render::opengl::GLProgram GL_obj::createProgram( ){
	HX_STACK_FRAME("snow.platform.native.render.opengl.GL","createProgram",0xb12e7d2d,"snow.platform.native.render.opengl.GL.createProgram","snow/platform/native/render/opengl/GL.hx",763,0x9056cf0a)
	HX_STACK_LINE(763)
	return ::snow::platform::native::render::opengl::GLProgram_obj::__new(::snow::platform::native::render::opengl::GL_obj::snow_gl_create_program());
}
...
::snow::platform::native::render::opengl::GLShader GL_obj::createShader( int type){
	HX_STACK_FRAME("snow.platform.native.render.opengl.GL","createShader",0xb7ce549c,"snow.platform.native.render.opengl.GL.createShader","snow/platform/native/render/opengl/GL.hx",773,0x9056cf0a)
	HX_STACK_ARG(type,"type")
	HX_STACK_LINE(773)
	return ::snow::platform::native::render::opengl::GLShader_obj::__new(::snow::platform::native::render::opengl::GL_obj::snow_gl_create_shader(type));
}
...
::snow::platform::native::render::opengl::GLTexture GL_obj::createTexture( ){
	HX_STACK_FRAME("snow.platform.native.render.opengl.GL","createTexture",0x5c15fb84,"snow.platform.native.render.opengl.GL.createTexture","snow/platform/native/render/opengl/GL.hx",778,0x9056cf0a)
	HX_STACK_LINE(778)
	return ::snow::platform::native::render::opengl::GLTexture_obj::__new(::snow::platform::native::render::opengl::GL_obj::snow_gl_create_texture());
}
...
{
		HX_STACK_FRAME("snow.platform.native.render.opengl.GL","readPixels",0x196a8bbe,"snow.platform.native.render.opengl.GL.readPixels","snow/platform/native/render/opengl/GL.hx",1096,0x9056cf0a)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_ARG(width,"width")
		HX_STACK_ARG(height,"height")
		...
		HX_STACK_LINE(1097)
		::snow::platform::native::render::opengl::GL_obj::snow_gl_read_pixels(x,y,width,height,format,type,_g,(  (((pixels == null()))) ? Dynamic(null()) : Dynamic(pixels->byteOffset) ));
	}
return null();
}
...
{
		HX_STACK_FRAME("snow.platform.native.render.opengl.GL","texImage2D",0x4cac3561,"snow.platform.native.render.opengl.GL.texImage2D","snow/platform/native/render/opengl/GL.hx",1151,0x9056cf0a)
		HX_STACK_ARG(target,"target")
		HX_STACK_ARG(level,"level")
		HX_STACK_ARG(internalformat,"internalformat")
		HX_STACK_ARG(width,"width")
		...
		HX_STACK_LINE(1152)
		::snow::platform::native::render::opengl::GL_obj::snow_gl_tex_image_2d(target,level,internalformat,width,height,border,format,type,_g,(  (((pixels == null()))) ? Dynamic(null()) : Dynamic(pixels->byteOffset) ));
	}
return null();
}
...
{
		HX_STACK_FRAME("snow.platform.native.render.opengl.GL","texSubImage2D",0xfd828959,"snow.platform.native.render.opengl.GL.texSubImage2D","snow/platform/native/render/opengl/GL.hx",1166,0x9056cf0a)
		HX_STACK_ARG(target,"target")
		HX_STACK_ARG(level,"level")
		HX_STACK_ARG(xoffset,"xoffset")
		HX_STACK_ARG(yoffset,"yoffset")
		...
		HX_STACK_LINE(1167)
		::snow::platform::native::render::opengl::GL_obj::snow_gl_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,type,_g,(  (((pixels == null()))) ? Dynamic(null()) : Dynamic(pixels->byteOffset) ));
	}
return null();
}
