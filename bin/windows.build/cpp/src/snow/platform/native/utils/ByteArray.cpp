...
Void ByteArray_obj::compress( ::snow::platform::native::utils::Compression algorithm){
{
		...
		if (((algorithm == ::snow::platform::native::utils::Compression_obj::LZMA))){
			HX_STACK_LINE(122)
			result = ::haxe::io::Bytes_obj::ofData(::snow::platform::native::utils::ByteArray_obj::snow_lzma_encode(src->b));
		}
		else{
			HX_STACK_LINE(126)
			...
			HX_STACK_LINE(135)
			result = ::haxe::zip::Compress_obj::run(src,(int)8);
		}
		HX_STACK_LINE(140)
		this->b = result->b;
		HX_STACK_LINE(141)
...
Void ByteArray_obj::uncompress( ::snow::platform::native::utils::Compression algorithm){
{
		...
		if (((algorithm == ::snow::platform::native::utils::Compression_obj::LZMA))){
			HX_STACK_LINE(166)
			result = ::haxe::io::Bytes_obj::ofData(::snow::platform::native::utils::ByteArray_obj::snow_lzma_decode(src->b));
		}
		else{
			HX_STACK_LINE(170)
			int windowBits;		HX_STACK_VAR(windowBits,"windowBits");
			...
			HX_STACK_LINE(179)
			result = ::haxe::zip::Uncompress_obj::run(src,null());
		}
		HX_STACK_LINE(184)
		this->b = result->b;
		HX_STACK_LINE(185)
...
bool ByteArray_obj::readBoolean( ){
	...
	if (((this->position < this->length))){
		struct _Function_2_1{
			inline static int Block( ::snow::platform::native::utils::ByteArray_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","snow/platform/native/utils/ByteArray.hx",293,0xdcd92e53)
				{
					HX_STACK_LINE(293)
					int pos = (__this->position)++;		HX_STACK_VAR(pos,"pos");
					HX_STACK_LINE(293)
					return __this->b->__get(pos);
				}
				return null();
			}
		};
		HX_STACK_LINE(293)
		return (_Function_2_1::Block(this) != (int)0);
	}
	else{
		HX_STACK_LINE(293)
		return (HX_STACK_DO_THROW(HX_CSTRING("/ ByteArray / EOFError")) != (int)0);
	}
	HX_STACK_LINE(293)
	return false;
}
...
{
		HX_STACK_FRAME("snow.platform.native.utils.ByteArray","write_uncheck",0x3cd1016e,"snow.platform.native.utils.ByteArray.write_uncheck","snow/platform/native/utils/ByteArray.hx",484,0xdcd92e53)
		HX_STACK_THIS(this)
...
Void ByteArray_obj::writeDouble( Float x){
{
		...
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(527)
		::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofData(::snow::platform::native::utils::ByteArray_obj::std_double_bytes(x,this->bigEndian));		HX_STACK_VAR(bytes,"bytes");
		HX_STACK_LINE(530)
		{
			HX_STACK_LINE(530)
...
Void ByteArray_obj::writeFloat( Float x){
{
		...
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(539)
		::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofData(::snow::platform::native::utils::ByteArray_obj::std_float_bytes(x,this->bigEndian));		HX_STACK_VAR(bytes,"bytes");
		HX_STACK_LINE(542)
		{
			HX_STACK_LINE(542)
			int inOffset = (int)0;		HX_STACK_VAR(inOffset,"inOffset");
