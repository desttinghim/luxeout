...
Void InputSystem_obj::on_event( Dynamic _event){
{
		...
		if (((_event->__Field(HX_CSTRING("type"),true) == (int)1))){
			...
			if (((_event->__Field(HX_CSTRING("event"),true)->__Field(HX_CSTRING("type"),true) == (int)768))){
				HX_STACK_LINE(82)
				this->manager->dispatch_key_down_event(_key_event->__Field(HX_CSTRING("keysym"),true)->__Field(HX_CSTRING("sym"),true),_key_event->__Field(HX_CSTRING("keysym"),true)->__Field(HX_CSTRING("scancode"),true),_key_event->__Field(HX_CSTRING("repeat"),true),this->mod_state_from_event(_event),_event->__Field(HX_CSTRING("timestamp"),true),_event->__Field(HX_CSTRING("window_id"),true));
			}
			else{
				HX_STACK_LINE(91)
				if (((_event->__Field(HX_CSTRING("event"),true)->__Field(HX_CSTRING("type"),true) == (int)769))){
					...
					if (((bool((_event->__Field(HX_CSTRING("event"),true)->__Field(HX_CSTRING("type"),true) == (int)770)) || bool((_event->__Field(HX_CSTRING("event"),true)->__Field(HX_CSTRING("type"),true) == (int)771))))){
						...
						HX_STACK_LINE(106)
						if (((_event->__Field(HX_CSTRING("event"),true)->__Field(HX_CSTRING("start"),true) == null()))){
							HX_STACK_LINE(106)
							_g = (int)0;
						}
						else{
							HX_STACK_LINE(106)
							_g = _event->__Field(HX_CSTRING("event"),true)->__Field(HX_CSTRING("start"),true);
						}
						HX_STACK_LINE(107)
						int _g1;		HX_STACK_VAR(_g1,"_g1");
						HX_STACK_LINE(107)
						if (((_event->__Field(HX_CSTRING("event"),true)->__Field(HX_CSTRING("length"),true) == null()))){
							HX_STACK_LINE(107)
							_g1 = (int)0;
						}
						else{
							HX_STACK_LINE(107)
							_g1 = _event->__Field(HX_CSTRING("event"),true)->__Field(HX_CSTRING("length"),true);
						}
						HX_STACK_LINE(104)
						this->manager->dispatch_text_event(_event->__Field(HX_CSTRING("event"),true)->__Field(HX_CSTRING("text"),true),_g,_g1,(  (((_event->__Field(HX_CSTRING("event"),true)->__Field(HX_CSTRING("type"),true) == (int)770))) ? int((int)1) : int((int)2) ),_event->__Field(HX_CSTRING("timestamp"),true),_event->__Field(HX_CSTRING("window_id"),true));
					}
				}
			}
		}
