...
HX_STACK_ARG(_lib,"_lib")
{
	...
	this->lib = _lib;
	HX_STACK_LINE(50)
	this->list = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(51)
	this->platform = ::snow::platform::native::assets::AssetSystem_obj::__new(hx::ObjectPtr<OBJ_>(this));
}
;
	return null();
}
...
Void Assets_obj::add( Dynamic _list){
{
		...
		HX_STACK_LINE(58)
		while(((_g < _list->__Field(HX_CSTRING("length"),true)))){
			HX_STACK_LINE(58)
...
::snow::assets::AssetBytes Assets_obj::bytes( ::String _id,Dynamic options){
	...
	if ((this->exists(_id,_strict))){
		...
		if (((info == null()))){
			HX_STACK_LINE(131)
			info = this->info_from_id(_id,HX_CSTRING("bytes"));
		}
		HX_STACK_LINE(134)
...
::snow::assets::AssetText Assets_obj::text( ::String _id,Dynamic options){
	...
	if ((this->exists(_id,_strict))){
		...
		if (((info == null()))){
			HX_STACK_LINE(162)
			info = this->info_from_id(_id,HX_CSTRING("text"));
		}
		HX_STACK_LINE(165)
...
::snow::assets::AssetImage Assets_obj::image( ::String _id,Dynamic options){
	...
	if (((  ((!(this->exists(_id,_strict)))) ? bool(from_bytes) : bool(true) ))){
		...
		if (((info == null()))){
			HX_STACK_LINE(198)
			info = this->info_from_id(_id,HX_CSTRING("image"));
		}
		HX_STACK_LINE(201)
...
::snow::assets::AssetAudio Assets_obj::audio( ::String _id,Dynamic options){
	...
	if ((this->exists(_id,_strict))){
		...
		if (((info == null()))){
			HX_STACK_LINE(236)
			info = this->info_from_id(_id,HX_CSTRING("audio"));
		}
		HX_STACK_LINE(243)
		if (((options == null()))){
			struct _Function_3_1{
...
Dynamic Assets_obj::info_from_id( ::String _id,::String _type){
	HX_STACK_FRAME("snow.assets.Assets","info_from_id",0xdd28340a,"snow.assets.Assets.info_from_id","snow/assets/Assets.hx",284,0xda52227b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_id,"_id")
	HX_STACK_ARG(_type,"_type")
	struct _Function_1_1{
		inline static Dynamic Block( ::String &_type,::String &_id){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","snow/assets/Assets.hx",284,0xda52227b)
			{
				...
				__result->Add(HX_CSTRING("ext") , ::haxe::io::Path_obj::extension(_id),false);
	...
	HX_STACK_LINE(284)
	return _Function_1_1::Block(_type,_id);
}
