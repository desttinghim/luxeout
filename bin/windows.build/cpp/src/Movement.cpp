...
Void Movement_obj::__construct(Dynamic _options)
{
HX_STACK_FRAME("Movement","new",0x298135c1,"Movement.new","Movement.hx",6,0xa8f07ccf)
...
hx::ObjectPtr< Movement_obj > Movement_obj::__new(Dynamic _options)
...
{
		HX_STACK_FRAME("Movement","init",0x24468a8f,"Movement.init","Movement.hx",11,0xa8f07ccf)
		HX_STACK_THIS(this)
		HX_STACK_LINE(13)
		this->sprite = this->get_entity();
		HX_STACK_LINE(14)
		this->velocity = ::phoenix::Vector_obj::__new(null(),null(),null(),null());
	}
return null();
}
...
{
		HX_STACK_FRAME("Movement","update",0x9aa2f348,"Movement.update","Movement.hx",19,0xa8f07ccf)
		HX_STACK_THIS(this)
		HX_STACK_ARG(dt,"dt")
		struct _Function_1_1{
			inline static ::phoenix::Vector Block( ::Movement_obj *__this,Float &dt){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","Movement.hx",19,0xa8f07ccf)
				{
					HX_STACK_LINE(19)
...
{
		HX_STACK_FRAME("Movement","onreset",0xfffaa231,"Movement.onreset","Movement.hx",22,0xa8f07ccf)
		HX_STACK_THIS(this)
	}
return null();
}
