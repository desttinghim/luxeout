...
HX_STACK_ARG(_core,"_core")
{
	...
	this->core = _core;
	HX_STACK_LINE(83)
	this->default_fbo = ::snow::platform::native::render::opengl::GL_obj::getParameter((int)36006);
	HX_STACK_LINE(84)
	this->default_rbo = ::snow::platform::native::render::opengl::GL_obj::getParameter((int)36007);
	HX_STACK_LINE(138)
	Dynamic();
}
;
...
Void Renderer_obj::init( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(93)
		this->state = ::phoenix::RenderState_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(94)
		this->clear_color = ::phoenix::Color_obj::__new(null(),null(),null(),null())->rgb((int)1710618);
		HX_STACK_LINE(95)
		this->stats = ::phoenix::RendererStats_obj::__new();
		HX_STACK_LINE(96)
		this->batchers = Array_obj< ::Dynamic >::__new();
		HX_STACK_LINE(99)
		::luxe::Screen _g = ::Luxe_obj::get_screen();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(99)
		this->target_size = ::phoenix::Vector_obj::__new(_g->w,::Luxe_obj::get_screen()->h,null(),null());
		HX_STACK_LINE(100)
		this->camera = ::phoenix::Camera_obj::__new(null());
		HX_STACK_LINE(102)
		this->default_render_path = ::phoenix::RenderPath_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(104)
		this->render_path = this->default_render_path;
		HX_STACK_LINE(107)
		this->create_default_shaders();
		HX_STACK_LINE(110)
		this->batcher = ::phoenix::Batcher_obj::__new(hx::ObjectPtr<OBJ_>(this),HX_CSTRING("default batcher"));
		HX_STACK_LINE(111)
...
{
		HX_STACK_FRAME("phoenix.Renderer","destroy",0xe481d6ae,"phoenix.Renderer.destroy","phoenix/Renderer.hx",142,0x3d4c7b7b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(142)
		this->clear(::phoenix::Color_obj::__new(null(),null(),null(),null())->rgb((int)16729099));
	}
return null();
}
...
::phoenix::Batcher Renderer_obj::create_batcher( Dynamic options){
	...
	if (((options != null()))){
		...
		if (((options->__Field(HX_CSTRING("camera"),true) == null()))){
			HX_STACK_LINE(182)
			options->__FieldRef(HX_CSTRING("camera")) = ::phoenix::Camera_obj::__new(null());
		}
	}
	else{
		struct _Function_2_1{
			inline static Dynamic Block( int &_new_batcher_layer){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Renderer.hx",186,0x3d4c7b7b)
				{
					...
					__result->Add(HX_CSTRING("camera") , ::phoenix::Camera_obj::__new(null()),false);
		...
		HX_STACK_LINE(186)
		options = _Function_2_1::Block(_new_batcher_layer);
	}
	HX_STACK_LINE(193)
...
Void Renderer_obj::blend_mode( hx::Null< int >  __o__src_mode,hx::Null< int >  __o__dst_mode){
int _src_mode = __o__src_mode.Default(770);
...
Void Renderer_obj::blend_equation( hx::Null< int >  __o__equation){
int _equation = __o__equation.Default(32774);
...
{
		HX_STACK_FRAME("phoenix.Renderer","internal_resized",0xd68aa17a,"phoenix.Renderer.internal_resized","phoenix/Renderer.hx",239,0x3d4c7b7b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_w,"_w")
		HX_STACK_ARG(_h,"_h")
		HX_STACK_LINE(239)
...
Void Renderer_obj::create_default_shaders( ){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::String &frag,::phoenix::Shader &_plain,::String &vert){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Renderer.hx",355,0x3d4c7b7b)
				{
					...
					__result->Add(HX_CSTRING("source") , _Function_2_1::Block(frag,vert),false);
					return __result;
				}
				return null();
			}
		...
		HX_STACK_LINE(355)
		Dynamic _g = _Function_1_1::Block(frag,_plain,vert);		HX_STACK_VAR(_g,"_g");
		struct _Function_1_2{
			inline static Dynamic Block( ::String &frag_textured,::phoenix::Shader &_textured,::String &vert){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Renderer.hx",356,0x3d4c7b7b)
				{
					...
					__result->Add(HX_CSTRING("source") , _Function_2_1::Block(frag_textured,vert),false);
					return __result;
				}
				return null();
			}
		...
		HX_STACK_LINE(356)
		Dynamic _g1 = _Function_1_2::Block(frag_textured,_textured,vert);		HX_STACK_VAR(_g1,"_g1");
		struct _Function_1_3{
			inline static Dynamic Block( Dynamic &_g1,Dynamic &_g,::phoenix::Shader &_font,::String &vert,::String &frag_bitmapfont){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Renderer.hx",354,0x3d4c7b7b)
				{
					hx::Anon __result = hx::Anon_obj::Create();
					__result->Add(HX_CSTRING("plain") , _g,false);
					__result->Add(HX_CSTRING("textured") , _g1,false);
					struct _Function_2_1{
					...
					__result->Add(HX_CSTRING("bitmapfont") , _Function_2_1::Block(_font,vert,frag_bitmapfont),false);
					return __result;
				}
				return null();
			}
		...
		HX_STACK_LINE(354)
		this->shaders = _Function_1_3::Block(_g1,_g,_font,vert,frag_bitmapfont);
		HX_STACK_LINE(138)
		Dynamic();
	}
return null();
...
Void Renderer_obj::create_default_font( ){
{
		...
		HX_STACK_THIS(this)
		struct _Function_1_1{
			inline static Dynamic Block( ::phoenix::Renderer_obj *__this){
		...
		HX_STACK_LINE(368)
		this->font = ::phoenix::BitmapFont_obj::__new(_Function_1_1::Block(this));
		HX_STACK_LINE(371)
		...
		HX_STACK_LINE(375)
		::String _g = ::haxe::Resource_obj::getString(HX_CSTRING("default.fnt"));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(375)
		this->font->from_string(HX_CSTRING("default.fnt"),_g,HX_CSTRING(""),null(),Array_obj< ::Dynamic >::__new().Add(_font_texture),null());
		HX_STACK_LINE(138)
		Dynamic();
	}
return null();
