...
HX_STACK_ARG(_options,"_options")
{
	...
	HX_STACK_LINE(77)
	this->transform = ::phoenix::Transform_obj::__new();
	HX_STACK_LINE(80)
	this->options = _options;
	HX_STACK_LINE(83)
	if (((this->options == null()))){
		HX_STACK_LINE(84)
		this->options = this->default_camera_options();
	}
	HX_STACK_LINE(88)
	...
	HX_STACK_LINE(99)
	::luxe::Screen _g = ::Luxe_obj::get_screen();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(99)
	this->set_center(::phoenix::Vector_obj::__new((Float(_g->w) / Float((int)2)),(Float(::Luxe_obj::get_screen()->h) / Float((int)2)),null(),null()));
	HX_STACK_LINE(100)
	this->set_pos(::phoenix::Vector_obj::__new(null(),null(),null(),null()));
	HX_STACK_LINE(103)
	if (((this->options->__Field(HX_CSTRING("viewport"),true) != null()))){
		...
		HX_STACK_LINE(106)
		this->set_viewport(::phoenix::Rectangle_obj::__new((int)0,(int)0,_g1->w,::Luxe_obj::get_screen()->h));
	}
	HX_STACK_LINE(109)
	this->up = ::phoenix::Vector_obj::__new((int)0,(int)1,(int)0,null());
	HX_STACK_LINE(111)
	this->projection_matrix = ::phoenix::Matrix_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(112)
	this->view_matrix = ::phoenix::Matrix_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(113)
	this->view_matrix_inverse = ::phoenix::Matrix_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(114)
	this->look_at_matrix = ::phoenix::Matrix_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(116)
	{
		HX_STACK_LINE(116)
			...
			HX_STACK_LINE(248)
			{
				...
				HX_STACK_LINE(248)
				{
					...
					HX_STACK_LINE(248)
					{
						...
						HX_STACK_LINE(248)
						_z = ::phoenix::Vector_obj::__new((Float(_this1->x) / Float(b)),(Float(_this1->y) / Float(b)),(Float(_this1->z) / Float(b)),null());
					}
				}
				HX_STACK_LINE(248)
				...
				HX_STACK_LINE(248)
				{
					...
					HX_STACK_LINE(248)
					{
						...
						Float b = ::Math_obj::sqrt((((_this1->x * _this1->x) + (_this1->y * _this1->y)) + (_this1->z * _this1->z)));		HX_STACK_VAR(b,"b");
						HX_STACK_LINE(248)
						_x = ::phoenix::Vector_obj::__new((Float(_this1->x) / Float(b)),(Float(_this1->y) / Float(b)),(Float(_this1->z) / Float(b)),null());
					}
				}
				HX_STACK_LINE(248)
...
Void Camera_obj::update_view_matrix( ){
{
							...
							if ((!(_this2->dirty))){
								...
								if (((_this2->parent != null()))){
									...
									if (((_m != null()))){
										...
										HX_STACK_LINE(258)
										_this3->floats = ::snow::platform::native::utils::Float32Array_obj::__new(_this4->_float32array,null(),null());
									}
									HX_STACK_LINE(258)
									_this3->matrix;
								}
									...
									if ((_this3->auto_decompose)){
										...
										HX_STACK_LINE(258)
										{
											...
											if (((_this4->_transform == null()))){
												HX_STACK_LINE(258)
												_this4->_transform = ::phoenix::MatrixTransform_obj::__new(_position,_quaternion,_scale);
											}
											else{
												HX_STACK_LINE(258)
						...
						if ((!(_this1->dirty))){
							...
							if (((_this1->parent != null()))){
								...
								if (((_m != null()))){
									...
									HX_STACK_LINE(258)
									_this2->floats = ::snow::platform::native::utils::Float32Array_obj::__new(_this3->_float32array,null(),null());
								}
								HX_STACK_LINE(258)
								_this2->matrix;
							}
								...
								if ((_this2->auto_decompose)){
									...
									HX_STACK_LINE(258)
									{
										...
										if (((_this3->_transform == null()))){
											HX_STACK_LINE(258)
											_this3->_transform = ::phoenix::MatrixTransform_obj::__new(_position,_quaternion,_scale);
										}
										else{
											HX_STACK_LINE(258)
		...
		HX_STACK_LINE(264)
		{
			...
			HX_STACK_LINE(264)
			{
				...
				if (((det == (int)0))){
					...
					HX_STACK_LINE(264)
					this->view_matrix_inverse = _this1;
				}
				else{
					HX_STACK_LINE(264)
					{
		...
		HX_STACK_LINE(265)
		{
			...
			HX_STACK_LINE(265)
			this->view_inverse_float32array = ::snow::platform::native::utils::Float32Array_obj::__new(_this->_float32array,null(),null());
		}
		HX_STACK_LINE(267)
...
Void Camera_obj::update_projection_matrix( ){
{
		...
		HX_STACK_LINE(277)
		{
			...
			switch( (int)(_g->__Index())){
				case (int)1: {
					...
					HX_STACK_LINE(280)
					Float ymax = (_near * ::Math_obj::tan(((this->fov_y * 0.5) * 0.017453292519943278)));		HX_STACK_VAR(ymax,"ymax");
					HX_STACK_LINE(280)
		...
		HX_STACK_LINE(287)
		{
			...
			HX_STACK_LINE(287)
			this->projection_float32array = ::snow::platform::native::utils::Float32Array_obj::__new(_this->_float32array,null(),null());
		}
		HX_STACK_LINE(289)
...
Float Camera_obj::set_fov( Float _fov){
	...
	if (((this->fov_type == ::phoenix::FOVType_obj::horizontal))){
		HX_STACK_LINE(398)
		this->fov_y = ((Float((int)180) / Float(::Math_obj::PI)) * (((int)2 * ::Math_obj::atan((::Math_obj::tan((Float((_fov * ((Float(::Math_obj::PI) / Float((int)180))))) / Float((int)2))) * ((Float((int)1) / Float(this->aspect))))))));
	}
	else{
		HX_STACK_LINE(400)
		this->fov_y = _fov;
...
::phoenix::Vector Camera_obj::set_center( ::phoenix::Vector _p){
	...
	HX_STACK_LINE(504)
	::phoenix::Vector_obj::Listen(this->get_center(),this->_center_changed_dyn());
	HX_STACK_LINE(506)
				...
				HX_STACK_LINE(541)
				{
					...
					HX_STACK_LINE(541)
					{
						...
						if (((bool((bool((bool(_this->dirty) && bool(!(_this->_setup)))) && bool((_this->_dirty_handlers != null())))) && bool((_this->_dirty_handlers->__Field(HX_CSTRING("length"),true) > (int)0))))){
							...
							HX_STACK_LINE(541)
							while(((_g1 < _g11->__Field(HX_CSTRING("length"),true)))){
								HX_STACK_LINE(541)
...
::phoenix::Vector Camera_obj::set_pos( ::phoenix::Vector _p){
	...
	HX_STACK_LINE(598)
	::phoenix::Vector_obj::Listen(this->get_pos(),this->_pos_changed_dyn());
	HX_STACK_LINE(600)
	return this->get_pos();
}
...
{
		HX_STACK_FRAME("phoenix.Camera","_pos_changed",0x32241af4,"phoenix.Camera._pos_changed","phoenix/Camera.hx",658,0x1fcabb59)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(658)
		this->set_pos(this->get_pos());
...
{
		HX_STACK_FRAME("phoenix.Camera","_center_changed",0xdc3d733f,"phoenix.Camera._center_changed","phoenix/Camera.hx",664,0x1fcabb59)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(664)
