...
HX_STACK_ARG(_options,"_options")
{
	...
	HX_STACK_LINE(51)
	this->quads = ::haxe::ds::IntMap_obj::__new();
}
;
	return null();
}
...
int QuadPackGeometry_obj::quad_add( Dynamic _options){
	...
	HX_STACK_LINE(72)
	::phoenix::geometry::Vertex vert0 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(_options->__Field(HX_CSTRING("x"),true),_options->__Field(HX_CSTRING("y"),true),null(),null()),_options->__Field(HX_CSTRING("color"),true),null());		HX_STACK_VAR(vert0,"vert0");
	HX_STACK_LINE(73)
	::phoenix::geometry::Vertex vert1 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((_options->__Field(HX_CSTRING("x"),true) + _options->__Field(HX_CSTRING("w"),true)),_options->__Field(HX_CSTRING("y"),true),null(),null()),_options->__Field(HX_CSTRING("color"),true),null());		HX_STACK_VAR(vert1,"vert1");
	HX_STACK_LINE(74)
	::phoenix::geometry::Vertex vert2 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((_options->__Field(HX_CSTRING("x"),true) + _options->__Field(HX_CSTRING("w"),true)),(_options->__Field(HX_CSTRING("y"),true) + _options->__Field(HX_CSTRING("h"),true)),null(),null()),_options->__Field(HX_CSTRING("color"),true),null());		HX_STACK_VAR(vert2,"vert2");
	HX_STACK_LINE(77)
	::phoenix::geometry::Vertex vert3 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(_options->__Field(HX_CSTRING("x"),true),(_options->__Field(HX_CSTRING("y"),true) + _options->__Field(HX_CSTRING("h"),true)),null(),null()),_options->__Field(HX_CSTRING("color"),true),null());		HX_STACK_VAR(vert3,"vert3");
	HX_STACK_LINE(78)
	::phoenix::geometry::Vertex vert4 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(_options->__Field(HX_CSTRING("x"),true),_options->__Field(HX_CSTRING("y"),true),null(),null()),_options->__Field(HX_CSTRING("color"),true),null());		HX_STACK_VAR(vert4,"vert4");
	HX_STACK_LINE(79)
	::phoenix::geometry::Vertex vert5 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((_options->__Field(HX_CSTRING("x"),true) + _options->__Field(HX_CSTRING("w"),true)),(_options->__Field(HX_CSTRING("y"),true) + _options->__Field(HX_CSTRING("h"),true)),null(),null()),_options->__Field(HX_CSTRING("color"),true),null());		HX_STACK_VAR(vert5,"vert5");
	HX_STACK_LINE(82)
	this->add(vert0);
	HX_STACK_LINE(84)
	this->add(vert1);
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &_options,Array< ::Dynamic > &_g,int &_uid){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/geometry/QuadPackGeometry.hx",95,0xc786266f)
			{
				...
				__result->Add(HX_CSTRING("verts") , _g,false);
				...
				__result->Add(HX_CSTRING("_uv_cache") , ::phoenix::Rectangle_obj::__new((int)0,(int)0,(int)1,(int)1),false);
				return __result;
			}
			return null();
		}
	...
	HX_STACK_LINE(95)
	Dynamic _quad = _Function_1_1::Block(_options,_g,_uid);		HX_STACK_VAR(_quad,"_quad");
	HX_STACK_LINE(104)
...
Void QuadPackGeometry_obj::quad_resize( int _quad_id,::phoenix::Rectangle _size){
{
		...
		if (((_quad != null()))){
			HX_STACK_LINE(190)
			_quad->__Field(HX_CSTRING("verts"),true)->__GetItem((int)0)->__FieldRef(HX_CSTRING("pos")) = ::phoenix::Vector_obj::__new(_size->x,_size->y,null(),null());
			HX_STACK_LINE(191)
			_quad->__Field(HX_CSTRING("verts"),true)->__GetItem((int)1)->__FieldRef(HX_CSTRING("pos")) = ::phoenix::Vector_obj::__new((_size->x + _size->w),_size->y,null(),null());
			HX_STACK_LINE(192)
			_quad->__Field(HX_CSTRING("verts"),true)->__GetItem((int)2)->__FieldRef(HX_CSTRING("pos")) = ::phoenix::Vector_obj::__new((_size->x + _size->w),(_size->y + _size->h),null(),null());
			HX_STACK_LINE(194)
			_quad->__Field(HX_CSTRING("verts"),true)->__GetItem((int)3)->__FieldRef(HX_CSTRING("pos")) = ::phoenix::Vector_obj::__new(_size->x,(_size->y + _size->h),null(),null());
			HX_STACK_LINE(195)
			_quad->__Field(HX_CSTRING("verts"),true)->__GetItem((int)4)->__FieldRef(HX_CSTRING("pos")) = ::phoenix::Vector_obj::__new(_size->x,_size->y,null(),null());
			HX_STACK_LINE(196)
			_quad->__Field(HX_CSTRING("verts"),true)->__GetItem((int)5)->__FieldRef(HX_CSTRING("pos")) = ::phoenix::Vector_obj::__new((_size->x + _size->w),(_size->y + _size->h),null(),null());
			HX_STACK_LINE(199)
			this->set_dirty(true);
		}
	}
...
Void QuadPackGeometry_obj::quad_uv( int _quad_id,::phoenix::Rectangle _uv){
{
		...
		HX_STACK_LINE(359)
		this->quad_uv_space(_quad_id,::phoenix::Rectangle_obj::__new(tlx,tly,szx,szy));
	}
return null();
}
