...
{
	HX_STACK_LINE(20)
	this->uv = ::phoenix::geometry::TextureCoordSet_obj::__new();
	HX_STACK_LINE(22)
	this->pos = _pos;
	HX_STACK_LINE(23)
	if (((_color == null()))){
		HX_STACK_LINE(23)
		this->color = ::phoenix::Color_obj::__new(null(),null(),null(),null());
	}
	else{
		HX_STACK_LINE(23)
		this->color = _color;
	...
	if (((_normal == null()))){
		HX_STACK_LINE(24)
		this->normal = ::phoenix::Vector_obj::__new(null(),null(),null(),null());
	}
	else{
		HX_STACK_LINE(24)
		this->normal = _normal;
...
::phoenix::geometry::Vertex Vertex_obj::clone( ){
	...
	struct _Function_1_1{
		inline static ::phoenix::Vector Block( ::phoenix::geometry::Vertex_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/geometry/Vertex.hx",30,0xf444629d)
			{
				HX_STACK_LINE(30)
				::phoenix::Vector _this = __this->normal;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(30)
	...
	HX_STACK_LINE(30)
	::phoenix::geometry::Vertex _new = ::phoenix::geometry::Vertex_obj::__new(_g,_g1,_Function_1_1::Block(this));		HX_STACK_VAR(_new,"_new");
	HX_STACK_LINE(31)
	{
		HX_STACK_LINE(31)
