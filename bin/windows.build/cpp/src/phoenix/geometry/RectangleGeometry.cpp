...
Void RectangleGeometry_obj::set( Dynamic options){
{
		...
		HX_STACK_LINE(42)
		::phoenix::geometry::Vertex vert0 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((int)0,(int)0,null(),null()),null(),null());		HX_STACK_VAR(vert0,"vert0");
		HX_STACK_LINE(43)
		{
			HX_STACK_LINE(43)
		...
		HX_STACK_LINE(45)
		::phoenix::geometry::Vertex vert1 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(_w,(int)0,null(),null()),null(),null());		HX_STACK_VAR(vert1,"vert1");
		HX_STACK_LINE(46)
		{
			HX_STACK_LINE(46)
		...
		HX_STACK_LINE(49)
		::phoenix::geometry::Vertex vert2 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(_w,(int)0,null(),null()),null(),null());		HX_STACK_VAR(vert2,"vert2");
		HX_STACK_LINE(50)
		{
			HX_STACK_LINE(50)
		...
		HX_STACK_LINE(52)
		::phoenix::geometry::Vertex vert3 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(_w,_h,null(),null()),null(),null());		HX_STACK_VAR(vert3,"vert3");
		HX_STACK_LINE(53)
		{
			HX_STACK_LINE(53)
		...
		HX_STACK_LINE(56)
		::phoenix::geometry::Vertex vert4 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(_w,_h,null(),null()),null(),null());		HX_STACK_VAR(vert4,"vert4");
		HX_STACK_LINE(57)
		{
			HX_STACK_LINE(57)
		...
		HX_STACK_LINE(59)
		::phoenix::geometry::Vertex vert5 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((int)0,_h,null(),null()),null(),null());		HX_STACK_VAR(vert5,"vert5");
		HX_STACK_LINE(60)
		{
			HX_STACK_LINE(60)
		...
		HX_STACK_LINE(63)
		::phoenix::geometry::Vertex vert6 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((int)0,_h,null(),null()),null(),null());		HX_STACK_VAR(vert6,"vert6");
		HX_STACK_LINE(64)
		{
			HX_STACK_LINE(64)
		...
		HX_STACK_LINE(66)
		::phoenix::geometry::Vertex vert7 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((int)0,(int)0,null(),null()),null(),null());		HX_STACK_VAR(vert7,"vert7");
		HX_STACK_LINE(67)
		{
			HX_STACK_LINE(67)
