...
HX_STACK_ARG(options,"options")
{
	...
	HX_STACK_LINE(34)
	this->set(::phoenix::Rectangle_obj::__new(options->__Field(HX_CSTRING("x"),true),options->__Field(HX_CSTRING("y"),true),options->__Field(HX_CSTRING("w"),true),options->__Field(HX_CSTRING("h"),true)));
	HX_STACK_LINE(36)
...
Void QuadGeometry_obj::set( ::phoenix::Rectangle quad){
{
		...
		HX_STACK_LINE(143)
		::phoenix::geometry::Vertex vert0 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((int)0,(int)0,null(),null()),this->color,null());		HX_STACK_VAR(vert0,"vert0");
		HX_STACK_LINE(144)
		::phoenix::geometry::Vertex vert1 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(quad->w,(int)0,null(),null()),this->color,null());		HX_STACK_VAR(vert1,"vert1");
		HX_STACK_LINE(145)
		::phoenix::geometry::Vertex vert2 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(quad->w,quad->h,null(),null()),this->color,null());		HX_STACK_VAR(vert2,"vert2");
		HX_STACK_LINE(148)
		::phoenix::geometry::Vertex vert3 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((int)0,quad->h,null(),null()),this->color,null());		HX_STACK_VAR(vert3,"vert3");
		HX_STACK_LINE(149)
		::phoenix::geometry::Vertex vert4 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((int)0,(int)0,null(),null()),this->color,null());		HX_STACK_VAR(vert4,"vert4");
		HX_STACK_LINE(150)
		::phoenix::geometry::Vertex vert5 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(quad->w,quad->h,null(),null()),this->color,null());		HX_STACK_VAR(vert5,"vert5");
		HX_STACK_LINE(155)
		this->add(vert0);
		HX_STACK_LINE(157)
		this->add(vert1);
