...
HX_STACK_ARG(options,"options")
{
	...
	if (((options->__Field(HX_CSTRING("color"),true) == null()))){
		HX_STACK_LINE(22)
		options->__FieldRef(HX_CSTRING("color")) = ::phoenix::Color_obj::__new(null(),null(),null(),null());
	}
	HX_STACK_LINE(23)
	...
	if (((options->__Field(HX_CSTRING("p0"),true) != null()))){
		...
		HX_STACK_LINE(29)
		this->set_p0(::phoenix::Vector_obj::__new(null(),null(),null(),null()));
	}
	HX_STACK_LINE(32)
	if (((options->__Field(HX_CSTRING("p1"),true) != null()))){
		...
		HX_STACK_LINE(35)
		this->set_p1(::phoenix::Vector_obj::__new(null(),null(),null(),null()));
	}
	HX_STACK_LINE(38)
	this->set(options);
}
...
Void LineGeometry_obj::set( Dynamic options){
{
		...
		HX_STACK_LINE(71)
		::phoenix::geometry::Vertex vert0 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(options->__Field(HX_CSTRING("p0"),true)->__Field(HX_CSTRING("x"),true),options->__Field(HX_CSTRING("p0"),true)->__Field(HX_CSTRING("y"),true),options->__Field(HX_CSTRING("p0"),true)->__Field(HX_CSTRING("z"),true),null()),options->__Field(HX_CSTRING("color0"),true),null());		HX_STACK_VAR(vert0,"vert0");
		HX_STACK_LINE(72)
		{
			HX_STACK_LINE(72)
		...
		HX_STACK_LINE(74)
		::phoenix::geometry::Vertex vert1 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(options->__Field(HX_CSTRING("p1"),true)->__Field(HX_CSTRING("x"),true),options->__Field(HX_CSTRING("p1"),true)->__Field(HX_CSTRING("y"),true),options->__Field(HX_CSTRING("p1"),true)->__Field(HX_CSTRING("z"),true),null()),options->__Field(HX_CSTRING("color1"),true),null());		HX_STACK_VAR(vert1,"vert1");
		HX_STACK_LINE(75)
		{
			HX_STACK_LINE(75)
