...
HX_STACK_ARG(options,"options")
{
	...
	HX_STACK_LINE(32)
	this->_uv_cache = ::phoenix::Rectangle_obj::__new((int)0,(int)0,(int)1,(int)1);
	HX_STACK_LINE(35)
	this->set(::phoenix::Rectangle_obj::__new(options->__Field(HX_CSTRING("x"),true),options->__Field(HX_CSTRING("z"),true),options->__Field(HX_CSTRING("w"),true),options->__Field(HX_CSTRING("h"),true)),options->__Field(HX_CSTRING("y"),true));
	HX_STACK_LINE(37)
...
Void PlaneGeometry_obj::uv( ::phoenix::Rectangle _rect){
{
		...
		HX_STACK_LINE(54)
		this->uv_space(::phoenix::Rectangle_obj::__new(tlx,tly,szx,szy));
	}
return null();
}
...
Void PlaneGeometry_obj::set( ::phoenix::Rectangle quad,Float y){
{
		...
		HX_STACK_LINE(135)
		::phoenix::geometry::Vertex vert0 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((int)0,(int)0,(int)0,null()),this->color,null());		HX_STACK_VAR(vert0,"vert0");
		HX_STACK_LINE(136)
		::phoenix::geometry::Vertex vert1 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(quad->w,(int)0,(int)0,null()),this->color,null());		HX_STACK_VAR(vert1,"vert1");
		HX_STACK_LINE(137)
		::phoenix::geometry::Vertex vert2 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(quad->w,(int)0,quad->h,null()),this->color,null());		HX_STACK_VAR(vert2,"vert2");
		HX_STACK_LINE(140)
		::phoenix::geometry::Vertex vert3 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((int)0,(int)0,quad->h,null()),this->color,null());		HX_STACK_VAR(vert3,"vert3");
		HX_STACK_LINE(141)
		::phoenix::geometry::Vertex vert4 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((int)0,(int)0,(int)0,null()),this->color,null());		HX_STACK_VAR(vert4,"vert4");
		HX_STACK_LINE(142)
		::phoenix::geometry::Vertex vert5 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(quad->w,(int)0,quad->h,null()),this->color,null());		HX_STACK_VAR(vert5,"vert5");
		HX_STACK_LINE(147)
		this->add(vert5);
		HX_STACK_LINE(149)
		this->add(vert4);
		...
		this->is_set = true;
		HX_STACK_LINE(170)
		this->uv_space(::phoenix::Rectangle_obj::__new((int)0,(int)0,(int)1,(int)1));
	}
return null();
}
