	...
	HX_STACK_ARG(_end_angle_degrees,"_end_angle_degrees")
{
		...
		HX_STACK_LINE(50)
		{
			...
			while(((_g < _steps))){
				...
				if (((_index > (int)0))){
					...
					HX_STACK_LINE(66)
					this->add(::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(prevvert->x,prevvert->y,prevvert->z,prevvert->w),this->color,null()));
				}
				HX_STACK_LINE(69)
		...
		HX_STACK_LINE(83)
		this->add(::phoenix::geometry::Vertex_obj::__new(_segment_pos->__get((int)0).StaticCast< ::phoenix::Vector >(),this->color,null()));
		HX_STACK_LINE(86)
		{
			HX_STACK_LINE(86)
