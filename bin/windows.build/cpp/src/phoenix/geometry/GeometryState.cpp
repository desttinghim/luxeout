...
HX_STACK_FRAME("phoenix.geometry.GeometryState","new",0xdad5fe14,"phoenix.geometry.GeometryState.new","phoenix/geometry/GeometryState.hx",8,0xdf8297bc)
{
	...
	this->set_clip(false);
	HX_STACK_LINE(25)
	this->set_clip_rect(::phoenix::Rectangle_obj::__new(null(),null(),null(),null()));
	HX_STACK_LINE(26)
...
Void GeometryState_obj::str( ){
{
		...
		HX_STACK_LINE(53)
		::String _g = (HX_CSTRING("\t+ GEOMETRYSTATE ") + ::Std_obj::string(this->dirty));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(53)
		::haxe::Log_obj::trace(_g,hx::SourceInfo(HX_CSTRING("GeometryState.hx"),53,HX_CSTRING("phoenix.geometry.GeometryState"),HX_CSTRING("str")));
		HX_STACK_LINE(54)
		...
		HX_STACK_LINE(56)
		::haxe::Log_obj::trace((HX_CSTRING("\t\ttexture - ") + _g1),hx::SourceInfo(HX_CSTRING("GeometryState.hx"),56,HX_CSTRING("phoenix.geometry.GeometryState"),HX_CSTRING("str")));
		HX_STACK_LINE(57)
		if (((this->texture != null()))){
			HX_STACK_LINE(58)
			::String _g2 = (HX_CSTRING("\t\t\t ") + ::Std_obj::string(this->texture->texture));		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(58)
			::haxe::Log_obj::trace(_g2,hx::SourceInfo(HX_CSTRING("GeometryState.hx"),58,HX_CSTRING("phoenix.geometry.GeometryState"),HX_CSTRING("str")));
		}
		HX_STACK_LINE(60)
		...
		HX_STACK_LINE(60)
		::haxe::Log_obj::trace((HX_CSTRING("\t\tshader - ") + _g3),hx::SourceInfo(HX_CSTRING("GeometryState.hx"),60,HX_CSTRING("phoenix.geometry.GeometryState"),HX_CSTRING("str")));
		HX_STACK_LINE(61)
		::String _g4 = (HX_CSTRING("\t\tprimitive_type - ") + ::Std_obj::string(this->primitive_type));		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(61)
		::haxe::Log_obj::trace(_g4,hx::SourceInfo(HX_CSTRING("GeometryState.hx"),61,HX_CSTRING("phoenix.geometry.GeometryState"),HX_CSTRING("str")));
		HX_STACK_LINE(62)
		::String _g5 = (HX_CSTRING("\t\tclip - ") + ::Std_obj::string(this->clip));		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(62)
		::haxe::Log_obj::trace(_g5,hx::SourceInfo(HX_CSTRING("GeometryState.hx"),62,HX_CSTRING("phoenix.geometry.GeometryState"),HX_CSTRING("str")));
		HX_STACK_LINE(63)
		::String _g6 = (HX_CSTRING("\t\tclip rect - ") + ::Std_obj::string(this->clip_rect));		HX_STACK_VAR(_g6,"_g6");
		HX_STACK_LINE(63)
		::haxe::Log_obj::trace(_g6,hx::SourceInfo(HX_CSTRING("GeometryState.hx"),63,HX_CSTRING("phoenix.geometry.GeometryState"),HX_CSTRING("str")));
		HX_STACK_LINE(64)
