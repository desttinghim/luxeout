...
HX_STACK_ARG(options,"options")
{
	...
	if (((options->__Field(HX_CSTRING("steps"),true) == null()))){
		...
		if (((options->__Field(HX_CSTRING("smooth"),true) == null()))){
			...
			HX_STACK_LINE(52)
			options->__FieldRef(HX_CSTRING("steps")) = ::Luxe_obj::utils->geometry->segments_for_smooth_circle(_max,null());
		}
		else{
			HX_STACK_LINE(54)
			...
			Float _max = ::Math_obj::max(_radius_x,_radius_y);		HX_STACK_VAR(_max,"_max");
			HX_STACK_LINE(56)
			options->__FieldRef(HX_CSTRING("steps")) = ::Luxe_obj::utils->geometry->segments_for_smooth_circle(_max,_smooth);
		}
	}
	HX_STACK_LINE(61)
	...
	HX_STACK_ARG(_end_angle,"_end_angle")
{
		...
		HX_STACK_LINE(81)
		_steps = ::Math_obj::ceil(((Float(::Math_obj::abs(_range)) / Float(((::Math_obj::PI * (int)2)))) * _steps));
		HX_STACK_LINE(84)
		...
		HX_STACK_LINE(89)
		Float x = (_rx * ::Math_obj::cos(_start_angle_rad));		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(90)
		Float y = (_rx * ::Math_obj::sin(_start_angle_rad));		HX_STACK_VAR(y,"y");
		HX_STACK_LINE(93)
		...
		HX_STACK_LINE(100)
		{
			...
			HX_STACK_LINE(100)
			int _g = (_steps + (int)1);		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(100)
			while(((_g1 < _g))){
				HX_STACK_LINE(100)
				...
				if (((_index > (int)0))){
					HX_STACK_LINE(112)
					this->add(::phoenix::geometry::Vertex_obj::__new(_seg,this->color,null()));
				}
				HX_STACK_LINE(116)
				this->add(::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((int)0,(int)0,null(),null()),this->color,null()));
				HX_STACK_LINE(119)
				this->add(::phoenix::geometry::Vertex_obj::__new(_seg,this->color,null()));
				HX_STACK_LINE(121)
		...
		HX_STACK_LINE(134)
		this->add(::phoenix::geometry::Vertex_obj::__new(_segment_pos->__get(_steps).StaticCast< ::phoenix::Vector >(),this->color,null()));
		HX_STACK_LINE(137)
		{
			HX_STACK_LINE(137)
