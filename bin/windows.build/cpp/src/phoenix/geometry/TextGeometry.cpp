...
HX_STACK_ARG(_options,"_options")
{
	...
	HX_STACK_LINE(140)
	this->line_offsets = Array_obj< ::Dynamic >::__new().Add(_g).Add(Array_obj< Float >::__new());
	HX_STACK_LINE(141)
	this->lines = Array_obj< ::String >::__new();
	HX_STACK_LINE(142)
	this->set_outline_color(::phoenix::Color_obj::__new(null(),null(),null(),null()));
	HX_STACK_LINE(143)
	this->set_glow_color(::phoenix::Color_obj::__new(null(),null(),null(),null()));
	HX_STACK_LINE(145)
...
Void TextGeometry_obj::default_options( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(187)
		this->set_texture(this->font->pages->get((int)0));
		HX_STACK_LINE(191)
...
bool TextGeometry_obj::update_sizes( ){
	...
	HX_STACK_LINE(270)
	this->lines = drawn_text.split(HX_CSTRING("\n"));
	HX_STACK_LINE(272)
	...
	HX_STACK_LINE(274)
	{
		...
		for(::cpp::FastIterator_obj< int > *__it = ::cpp::CreateFastIterator< int >(::luxe::utils::unifill::CodePointIter_obj::__new(drawn_text));  __it->hasNext(); ){
			int _uglyph = __it->next();
			{
				...
				if (((_index == (int)10))){
					HX_STACK_LINE(274)
					_max_w = ::Math_obj::max(_max_w,_cur_x);
					HX_STACK_LINE(274)
					if ((_push_widths)){
						HX_STACK_LINE(274)
					...
					if (((i < (_len - (int)1)))){
						...
						HX_STACK_LINE(274)
						{
							...
							if (((  (((_map != null()))) ? bool(_map->exists(_next_index)) : bool(false) ))){
								HX_STACK_LINE(274)
								hx::AddEq(_spacing,_map->get(_next_index));
							}
							else{
								HX_STACK_LINE(274)
								hx::AddEq(_spacing,(int)0);
							}
						}
						HX_STACK_LINE(274)
...
;
		...
		HX_STACK_LINE(274)
		this->text_width = ::Math_obj::max(_max_w,_cur_x);
	}
	HX_STACK_LINE(275)
	{
		HX_STACK_LINE(275)
						...
						if (((_idx < (_line.length - (int)1)))){
							HX_STACK_LINE(409)
							{
								...
								if (((  (((_map != null()))) ? bool(_map->exists(_second)) : bool(false) ))){
									HX_STACK_LINE(409)
									hx::AddEq(_x_inc,_map->get(_second));
								}
								else{
									HX_STACK_LINE(409)
									hx::AddEq(_x_inc,(int)0);
								}
							}
							HX_STACK_LINE(410)
							if (((_index >= (int)32))){
...
Void TextGeometry_obj::update_char( int _letteridx,Float _x,Float _y,Float _w,Float _h,Float _u,Float _v,Float _u2,Float _v2,::phoenix::Color _color){
{
		...
		if (((quad == null()))){
			HX_STACK_LINE(456)
			vert0 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(_x,_y,null(),null()),_color,null());
			HX_STACK_LINE(457)
			vert1 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((_x + _w),_y,null(),null()),_color,null());
			HX_STACK_LINE(458)
			vert2 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((_x + _w),(_y + _h),null(),null()),_color,null());
			HX_STACK_LINE(460)
			vert3 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(_x,(_y + _h),null(),null()),_color,null());
			HX_STACK_LINE(461)
			vert4 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(_x,_y,null(),null()),_color,null());
			HX_STACK_LINE(462)
			vert5 = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((_x + _w),(_y + _h),null(),null()),_color,null());
			HX_STACK_LINE(464)
...
Float TextGeometry_obj::set_smoothness( Float s){
	...
	HX_STACK_LINE(609)
	if (((  (((  (((this->get_shader() != null()))) ? bool(this->sdf) : bool(false) ))) ? bool(this->unique) : bool(false) ))){
		HX_STACK_LINE(610)
...
{
		HX_STACK_FRAME("phoenix.geometry.TextGeometry","flush_uniforms",0x77bca14c,"phoenix.geometry.TextGeometry.flush_uniforms","phoenix/geometry/TextGeometry.hx",696,0x3cba14a2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(696)
		if (((  (((this->get_shader() != null()))) ? bool(this->sdf) : bool(false) ))){
			HX_STACK_LINE(697)
