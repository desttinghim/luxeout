...
{
	HX_STACK_LINE(19)
	this->uv0 = ::phoenix::geometry::TextureCoord_obj::__new(null(),null(),null(),null());
	HX_STACK_LINE(20)
	this->uv1 = ::phoenix::geometry::TextureCoord_obj::__new(null(),null(),null(),null());
	HX_STACK_LINE(21)
	this->uv2 = ::phoenix::geometry::TextureCoord_obj::__new(null(),null(),null(),null());
	HX_STACK_LINE(22)
	this->uv3 = ::phoenix::geometry::TextureCoord_obj::__new(null(),null(),null(),null());
	HX_STACK_LINE(23)
	this->uv4 = ::phoenix::geometry::TextureCoord_obj::__new(null(),null(),null(),null());
	HX_STACK_LINE(24)
	this->uv5 = ::phoenix::geometry::TextureCoord_obj::__new(null(),null(),null(),null());
	HX_STACK_LINE(25)
	this->uv6 = ::phoenix::geometry::TextureCoord_obj::__new(null(),null(),null(),null());
	HX_STACK_LINE(26)
	this->uv7 = ::phoenix::geometry::TextureCoord_obj::__new(null(),null(),null(),null());
}
;
	return null();
}
