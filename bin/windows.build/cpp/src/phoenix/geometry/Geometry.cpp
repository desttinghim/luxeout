...
HX_STACK_ARG(options,"options")
{
	...
	HX_STACK_LINE(105)
	this->uuid = ::Luxe_obj::utils->uniqueid(null());
	HX_STACK_LINE(106)
	this->id = this->uuid;
	HX_STACK_LINE(108)
	this->vertices = Array_obj< ::Dynamic >::__new();
	HX_STACK_LINE(109)
	this->state = ::phoenix::geometry::GeometryState_obj::__new();
	HX_STACK_LINE(110)
	this->batchers = Array_obj< ::Dynamic >::__new();
	HX_STACK_LINE(113)
	this->transform = ::phoenix::Transform_obj::__new();
	HX_STACK_LINE(116)
	this->_final_vert_position = ::phoenix::Vector_obj::__new(null(),null(),null(),null());
	HX_STACK_LINE(119)
	...
	if (((options != null()))){
		...
		HX_STACK_LINE(144)
		this->set_color((  (((options->__Field(HX_CSTRING("color"),true) == null()))) ? ::phoenix::Color(::phoenix::Color_obj::__new(null(),null(),null(),null())) : ::phoenix::Color(options->__Field(HX_CSTRING("color"),true)) ));
		HX_STACK_LINE(145)
	...
	HX_STACK_LINE(156)
	this->key = ::phoenix::geometry::GeometryKey_obj::__new();
	HX_STACK_LINE(158)
	this->key->uuid = this->uuid;
	HX_STACK_LINE(159)
	this->key->timestamp = ::Luxe_obj::get_time();
	HX_STACK_LINE(160)
...
::String Geometry_obj::key_string( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(182)
	::String _g = (((((((((HX_CSTRING("ts: ") + this->key->timestamp) + HX_CSTRING("\n")) + HX_CSTRING("sequence: ")) + this->key->sequence) + HX_CSTRING("\n")) + HX_CSTRING("primitive_type: ")) + ::Std_obj::string(this->key->primitive_type)) + HX_CSTRING("\n")) + HX_CSTRING("texture: "));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(182)
	::String _g1;		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(182)
	_g1 = (((_g + ((  (((this->key->texture == null()))) ? ::String(HX_CSTRING("null")) : ::String(this->key->texture->id) ))) + HX_CSTRING("\n")) + HX_CSTRING("shader: "));
	HX_STACK_LINE(182)
	::String _g2;		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(182)
	_g2 = (((((((((_g1 + ((  (((this->key->shader == null()))) ? ::String(HX_CSTRING("null")) : ::String(this->key->shader->id) ))) + HX_CSTRING("\n")) + HX_CSTRING("group: ")) + this->key->group) + HX_CSTRING("\n")) + HX_CSTRING("depth: ")) + this->key->depth) + HX_CSTRING("\n")) + HX_CSTRING("clip: "));
	HX_STACK_LINE(182)
	return (_g2 + ::Std_obj::string(this->key->clip));
}
									...
									if ((!(_this3->dirty))){
										...
										if (((_this3->parent != null()))){
											...
											if (((_m1 != null()))){
												...
												HX_STACK_LINE(261)
												_this4->floats = ::snow::platform::native::utils::Float32Array_obj::__new(_this5->_float32array,null(),null());
											}
											HX_STACK_LINE(261)
											_this4->matrix;
										}
										...
										HX_STACK_LINE(261)
										{
											...
											if ((_this4->auto_decompose)){
												...
												HX_STACK_LINE(261)
												{
													...
													HX_STACK_LINE(261)
													matrix->elements = _this5->elements->concat(Array_obj< Float >::__new());
													HX_STACK_LINE(261)
													...
													if (((_this5->_transform == null()))){
														HX_STACK_LINE(261)
														_this5->_transform = ::phoenix::MatrixTransform_obj::__new(_position,_quaternion,_scale);
													}
													else{
														HX_STACK_LINE(261)
										...
										HX_STACK_LINE(261)
										{
											...
											if (((bool((bool((bool(_this3->dirty) && bool(!(_this3->_setup)))) && bool((_this3->_dirty_handlers != null())))) && bool((_this3->_dirty_handlers->__Field(HX_CSTRING("length"),true) > (int)0))))){
												...
												HX_STACK_LINE(261)
												while(((_g2 < _g11->__Field(HX_CSTRING("length"),true)))){
													HX_STACK_LINE(261)
