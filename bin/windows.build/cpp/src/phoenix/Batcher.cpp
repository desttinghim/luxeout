...
::String _name = __o__name.Default(HX_CSTRING(""));
{
	...
	this->layer = (int)0;
	HX_STACK_LINE(145)
	this->id = ::Luxe_obj::utils->uniqueid(null());
	HX_STACK_LINE(146)
	this->renderer = _r;
	HX_STACK_LINE(147)
	this->sequence = ++(::phoenix::Batcher_obj::_sequence_key);
	HX_STACK_LINE(149)
	this->geometry = ::luxe::structural::BalancedBST_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry_obj::__new(this->geometry_compare_dyn());
	HX_STACK_LINE(150)
	this->groups = ::haxe::ds::IntMap_obj::__new();
	HX_STACK_LINE(152)
	this->max_verts = ::Std_obj::_int(::Math_obj::pow((int)2,(int)16));
	HX_STACK_LINE(153)
	this->max_floats = (int(this->max_verts) << int((int)2));
	HX_STACK_LINE(156)
	this->vertlist = ::snow::platform::native::utils::Float32Array_obj::__new(this->max_floats,null(),null());
	HX_STACK_LINE(157)
	this->tcoordlist = ::snow::platform::native::utils::Float32Array_obj::__new(this->max_floats,null(),null());
	HX_STACK_LINE(158)
	this->colorlist = ::snow::platform::native::utils::Float32Array_obj::__new(this->max_floats,null(),null());
	HX_STACK_LINE(161)
	this->static_vertlist = ::snow::platform::native::utils::Float32Array_obj::__new(this->max_floats,null(),null());
	HX_STACK_LINE(162)
	this->static_tcoordlist = ::snow::platform::native::utils::Float32Array_obj::__new(this->max_floats,null(),null());
	HX_STACK_LINE(163)
	this->static_colorlist = ::snow::platform::native::utils::Float32Array_obj::__new(this->max_floats,null(),null());
	HX_STACK_LINE(167)
	...
	if (((_name.length == (int)0))){
		HX_STACK_LINE(210)
		this->name = ::Luxe_obj::utils->uniqueid(null());
	}
	else{
		HX_STACK_LINE(212)
		this->name = _name;
...
Void Batcher_obj::add_group( int _group,Dynamic _pre_render,Dynamic _post_render){
{
		...
		HX_STACK_LINE(249)
		this->groups->get(_group)->__Field(HX_CSTRING("push"),true)(::phoenix::BatchGroup_obj::__new(_pre_render,_post_render));
	}
return null();
}
...
bool _force_add = __o__force_add.Default(false);
	HX_STACK_FRAME("phoenix.Batcher","add",0x3e78e95b,"phoenix.Batcher.add","phoenix/Batcher.hx",526,0xa9541457)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_geom,"_geom")
	HX_STACK_ARG(_force_add,"_force_add")
{
		HX_STACK_LINE(526)
		if (((  ((!(((this->geometry->find(_geom->key) == null()))))) ? bool(_force_add) : bool(true) ))){
			HX_STACK_LINE(529)
	...
	HX_STACK_ARG(persist_immediate,"persist_immediate")
{
		...
		this->normal_floats = (int)0;
		HX_STACK_LINE(635)
		this->state = ::phoenix::BatchState_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(637)
				...
				if (((bool((geom != null())) && bool(!(geom->dropped))))){
						...
						if ((_this->geom_state->clip)){
							...
							if (((_this->clip_rect != null()))){
								...
								if ((!(_this->clip_rect->equal(_this->last_clip_rect)))){
									...
									HX_STACK_LINE(660)
									int _g = ::Std_obj::_int(_this->clip_rect->x);		HX_STACK_VAR(_g,"_g");
									HX_STACK_LINE(660)
									int _g1 = ::Std_obj::_int(_y);		HX_STACK_VAR(_g1,"_g1");
									HX_STACK_LINE(660)
									int _g2 = ::Std_obj::_int(_this->clip_rect->w);		HX_STACK_VAR(_g2,"_g2");
									HX_STACK_LINE(660)
									::snow::platform::native::render::opengl::GL_obj::scissor(_g,_g1,_g2,::Std_obj::_int(_this->clip_rect->h));
								}
							}
						}
						else{
					...
					if ((geom->visible)){
						...
						if ((geom->get_locked())){
							...
							HX_STACK_LINE(673)
							if (((  ((!(((  ((!(((  ((!(((geom->get_primitive_type() == (int)3))))) ? bool((geom->get_primitive_type() == (int)2)) : bool(true) ))))) ? bool((geom->get_primitive_type() == (int)5)) : bool(true) ))))) ? bool((geom->get_primitive_type() == (int)6)) : bool(true) ))){
								HX_STACK_LINE(680)
				...
				if ((_this->geom_state->clip)){
					...
					if (((_this->clip_rect != null()))){
						...
						if ((!(_this->clip_rect->equal(_this->last_clip_rect)))){
							...
							Float _y = (this->view->get_viewport()->h - ((_this->clip_rect->y + _this->clip_rect->h)));		HX_STACK_VAR(_y,"_y");
							HX_STACK_LINE(721)
							int _g3 = ::Std_obj::_int(_this->clip_rect->x);		HX_STACK_VAR(_g3,"_g3");
							HX_STACK_LINE(721)
							int _g4 = ::Std_obj::_int(_y);		HX_STACK_VAR(_g4,"_g4");
							HX_STACK_LINE(721)
							int _g5 = ::Std_obj::_int(_this->clip_rect->w);		HX_STACK_VAR(_g5,"_g5");
							HX_STACK_LINE(721)
							::snow::platform::native::render::opengl::GL_obj::scissor(_g3,_g4,_g5,::Std_obj::_int(_this->clip_rect->h));
						}
					}
				}
				else{
	...
	HX_STACK_ARG(persist_immediate,"persist_immediate")
{
		...
		this->view->process();
		HX_STACK_LINE(746)
		::phoenix::Rectangle _g = this->view->get_viewport();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(746)
		::phoenix::Rectangle _g1 = this->view->get_viewport();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(746)
		::phoenix::Rectangle _g2 = this->view->get_viewport();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(746)
		this->renderer->state->viewport(_g->x,_g1->y,_g2->w,this->view->get_viewport()->h);
		HX_STACK_LINE(749)
...
Void Batcher_obj::submit_static_geometry( ::phoenix::geometry::Geometry geom){
{
		...
		if (((geom->static_vertex_buffer == null()))){
			HX_STACK_LINE(780)
			geom->static_vertex_buffer = ::snow::platform::native::render::opengl::GL_obj::createBuffer();
			HX_STACK_LINE(781)
			geom->static_tcoord_buffer = ::snow::platform::native::render::opengl::GL_obj::createBuffer();
			HX_STACK_LINE(782)
			geom->static_vcolor_buffer = ::snow::platform::native::render::opengl::GL_obj::createBuffer();
		}
		HX_STACK_LINE(787)
		...
		HX_STACK_LINE(822)
		::snow::platform::native::render::opengl::GL_obj::drawArrays(_g,(int)0,::phoenix::utils::Rendering_obj::get_elements_for_type(geom->get_primitive_type(),this->static_vert_floats));
		HX_STACK_LINE(828)
...
Void Batcher_obj::submit_current_vertex_list( int type){
{
		...
		HX_STACK_LINE(862)
		::snow::platform::native::render::opengl::GL_obj::bufferSubData((int)34962,(int)0,::snow::platform::native::utils::Float32Array_obj::__new(this->vertlist->buffer,(int)0,this->vert_floats));
		HX_STACK_LINE(864)
		...
		HX_STACK_LINE(866)
		::snow::platform::native::render::opengl::GL_obj::bufferSubData((int)34962,(int)0,::snow::platform::native::utils::Float32Array_obj::__new(this->tcoordlist->buffer,(int)0,this->tcoord_floats));
		HX_STACK_LINE(868)
		...
		HX_STACK_LINE(870)
		::snow::platform::native::render::opengl::GL_obj::bufferSubData((int)34962,(int)0,::snow::platform::native::utils::Float32Array_obj::__new(this->colorlist->buffer,(int)0,this->color_floats));
		HX_STACK_LINE(877)
		::snow::platform::native::render::opengl::GL_obj::drawArrays(type,(int)0,::phoenix::utils::Rendering_obj::get_elements_for_type(type,this->vert_floats));
		HX_STACK_LINE(883)
		this->_disable_attributes();
		HX_STACK_LINE(886)
		(this->buffer_index)++;
