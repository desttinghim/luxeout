...
Float Vector_obj::set_angle2D( Float value){
	...
	{
		HX_STACK_LINE(521)
		Float _x = (::Math_obj::cos(value) * len);		HX_STACK_VAR(_x,"_x");
		HX_STACK_LINE(521)
		Float _y = (::Math_obj::sin(value) * len);		HX_STACK_VAR(_y,"_y");
		HX_STACK_LINE(521)
		bool prev = this->ignore_listeners;		HX_STACK_VAR(prev,"prev");
		HX_STACK_LINE(521)
		this->ignore_listeners = true;
...
::phoenix::Vector Vector_obj::truncate( Float max){
	...
	{
		HX_STACK_LINE(540)
		Float value = ::Math_obj::min(max,::Math_obj::sqrt((((this->x * this->x) + (this->y * this->y)) + (this->z * this->z))));		HX_STACK_VAR(value,"value");
		HX_STACK_LINE(540)
		{
			HX_STACK_LINE(540)
			::phoenix::Vector _this;		HX_STACK_VAR(_this,"_this");
	...
	HX_STACK_ARG(order,"order")
{
		...
		if (((order == (int)0))){
			HX_STACK_LINE(632)
			_y = ::Math_obj::asin((  (((m13 < (int)-1))) ? Float((int)-1) : Float((  (((m13 > (int)1))) ? Float((int)1) : Float(m13) )) ));
			HX_STACK_LINE(634)
			if (((::Math_obj::abs(m13) < 0.99999))){
				HX_STACK_LINE(636)
				_x = ::Math_obj::atan2(-(m23),m33);
				HX_STACK_LINE(637)
				_z = ::Math_obj::atan2(-(m12),m11);
			}
			else{
				HX_STACK_LINE(639)
				_x = ::Math_obj::atan2(m32,m22);
				HX_STACK_LINE(640)
				_z = (int)0;
			}
		}
			...
			if (((order == (int)1))){
				HX_STACK_LINE(645)
				_x = ::Math_obj::asin(-(((  (((m23 < (int)-1))) ? Float((int)-1) : Float((  (((m23 > (int)1))) ? Float((int)1) : Float(m23) )) ))));
				HX_STACK_LINE(647)
				if (((::Math_obj::abs(m23) < 0.99999))){
					HX_STACK_LINE(648)
					_y = ::Math_obj::atan2(m13,m33);
					HX_STACK_LINE(649)
					_z = ::Math_obj::atan2(m21,m22);
				}
				else{
					HX_STACK_LINE(651)
					_y = ::Math_obj::atan2(-(m31),m11);
					HX_STACK_LINE(652)
					_z = (int)0;
				}
			}
				...
				if (((order == (int)2))){
					HX_STACK_LINE(657)
					_x = ::Math_obj::asin((  (((m32 < (int)-1))) ? Float((int)-1) : Float((  (((m32 > (int)1))) ? Float((int)1) : Float(m32) )) ));
					HX_STACK_LINE(659)
					if (((::Math_obj::abs(m32) < 0.99999))){
						HX_STACK_LINE(660)
						_y = ::Math_obj::atan2(-(m31),m33);
						HX_STACK_LINE(661)
						_z = ::Math_obj::atan2(-(m12),m22);
					}
					else{
						HX_STACK_LINE(663)
						_y = (int)0;
						HX_STACK_LINE(664)
						_z = ::Math_obj::atan2(m21,m11);
					}
				}
				else{
					HX_STACK_LINE(667)
					if (((order == (int)3))){
						HX_STACK_LINE(669)
						_y = ::Math_obj::asin(-(((  (((m31 < (int)-1))) ? Float((int)-1) : Float((  (((m31 > (int)1))) ? Float((int)1) : Float(m31) )) ))));
						HX_STACK_LINE(671)
						if (((::Math_obj::abs(m31) < 0.99999))){
							HX_STACK_LINE(672)
							_x = ::Math_obj::atan2(m32,m33);
							HX_STACK_LINE(673)
							_z = ::Math_obj::atan2(m21,m11);
						}
						else{
						...
						if (((order == (int)4))){
							HX_STACK_LINE(681)
							_z = ::Math_obj::asin((  (((m21 < (int)-1))) ? Float((int)-1) : Float((  (((m21 > (int)1))) ? Float((int)1) : Float(m21) )) ));
							HX_STACK_LINE(683)
							if (((::Math_obj::abs(m21) < 0.99999))){
								HX_STACK_LINE(684)
								_x = ::Math_obj::atan2(-(m23),m22);
								HX_STACK_LINE(685)
								_y = ::Math_obj::atan2(-(m31),m11);
							}
							else{
							...
							if (((order == (int)5))){
								HX_STACK_LINE(693)
								_z = ::Math_obj::asin(-(((  (((m12 < (int)-1))) ? Float((int)-1) : Float((  (((m12 > (int)1))) ? Float((int)1) : Float(m12) )) ))));
								HX_STACK_LINE(695)
								if (((::Math_obj::abs(m12) < 0.99999))){
									HX_STACK_LINE(696)
									_x = ::Math_obj::atan2(m32,m22);
									HX_STACK_LINE(697)
									_y = ::Math_obj::atan2(m13,m11);
								}
								else{
									HX_STACK_LINE(699)
									_x = ::Math_obj::atan2(-(m23),m33);
	...
	HX_STACK_ARG(order,"order")
{
		...
		if (((order == (int)0))){
			HX_STACK_LINE(723)
			_x = ::Math_obj::atan2(((int)2 * (((q->x * q->w) - (q->y * q->z)))),(((sqw - sqx) - sqy) + sqz));
			...
			HX_STACK_LINE(724)
			_y = ::Math_obj::asin(_Function_2_1::Block(q));
			HX_STACK_LINE(725)
			_z = ::Math_obj::atan2(((int)2 * (((q->z * q->w) - (q->x * q->y)))),(((sqw + sqx) - sqy) - sqz));
		}
		else{
			HX_STACK_LINE(726)
			if (((order == (int)1))){
				...
				HX_STACK_LINE(727)
				_x = ::Math_obj::asin(_Function_3_1::Block(q));
				HX_STACK_LINE(728)
				_y = ::Math_obj::atan2(((int)2 * (((q->x * q->z) + (q->y * q->w)))),(((sqw - sqx) - sqy) + sqz));
				HX_STACK_LINE(729)
				_z = ::Math_obj::atan2(((int)2 * (((q->x * q->y) + (q->z * q->w)))),(((sqw - sqx) + sqy) - sqz));
			}
			else{
				HX_STACK_LINE(730)
				if (((order == (int)2))){
					...
					HX_STACK_LINE(731)
					_x = ::Math_obj::asin(_Function_4_1::Block(q));
					HX_STACK_LINE(732)
					_y = ::Math_obj::atan2(((int)2 * (((q->y * q->w) - (q->z * q->x)))),(((sqw - sqx) - sqy) + sqz));
					HX_STACK_LINE(733)
					_z = ::Math_obj::atan2(((int)2 * (((q->z * q->w) - (q->x * q->y)))),(((sqw - sqx) + sqy) - sqz));
				}
				else{
					...
					if (((order == (int)3))){
						HX_STACK_LINE(735)
						_x = ::Math_obj::atan2(((int)2 * (((q->x * q->w) + (q->z * q->y)))),(((sqw - sqx) - sqy) + sqz));
						...
						HX_STACK_LINE(736)
						_y = ::Math_obj::asin(_Function_5_1::Block(q));
						HX_STACK_LINE(737)
						_z = ::Math_obj::atan2(((int)2 * (((q->x * q->y) + (q->z * q->w)))),(((sqw + sqx) - sqy) - sqz));
					}
					else{
						...
						if (((order == (int)4))){
							...
							_x = ::Math_obj::atan2(((int)2 * (((q->x * q->w) - (q->z * q->y)))),(((sqw - sqx) + sqy) - sqz));
							HX_STACK_LINE(740)
							_y = ::Math_obj::atan2(((int)2 * (((q->y * q->w) - (q->x * q->z)))),(((sqw + sqx) - sqy) - sqz));
							...
							HX_STACK_LINE(741)
							_z = ::Math_obj::asin(_Function_6_1::Block(q));
						}
						else{
							HX_STACK_LINE(742)
							if (((order == (int)5))){
								...
								HX_STACK_LINE(745)
								_z = ::Math_obj::asin(_Function_7_1::Block(q));
							}
						}
					}
				}
