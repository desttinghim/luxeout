...
Float Rendering_obj::fovx_to_y( Float fovx,Float aspect){
	HX_STACK_FRAME("phoenix.utils.Rendering","fovx_to_y",0xb6e51a8b,"phoenix.utils.Rendering.fovx_to_y","phoenix/utils/Rendering.hx",59,0x8a2baeb0)
	HX_STACK_ARG(fovx,"fovx")
	HX_STACK_ARG(aspect,"aspect")
	HX_STACK_LINE(59)
	return ((Float((int)180) / Float(::Math_obj::PI)) * (((int)2 * ::Math_obj::atan((::Math_obj::tan((Float((fovx * ((Float(::Math_obj::PI) / Float((int)180))))) / Float((int)2))) * ((Float((int)1) / Float(aspect))))))));
}
