...
HX_STACK_ARG(_manager,"_manager")
{
	...
	HX_STACK_LINE(57)
	this->uniform_textures = ::haxe::ds::StringMap_obj::__new();
}
;
	return null();
}
...
::phoenix::Shader Shader_obj::clone( ){
	...
	HX_STACK_LINE(76)
	_clone->id = ((this->id + HX_CSTRING(".clone.")) + ::Luxe_obj::utils->uniqueid(null()));
	HX_STACK_LINE(77)
...
Void Shader_obj::set_int( ::String _name,int _value){
{
		...
		if ((this->uniforms->exists(_name))){
			...
			struct _Function_2_1{
				inline static Dynamic Block( ::phoenix::Shader_obj *__this,::String &_name,int &_value){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Shader.hx",89,0x14ec92d9)
					{
						...
						__result->Add(HX_CSTRING("location") , ::snow::platform::native::render::opengl::GL_obj::getUniformLocation(__this->program,_name),false);
						return __result;
					}
					return null();
				}
			...
			HX_STACK_LINE(89)
			Dynamic _uniform = _Function_2_1::Block(this,_name,_value);		HX_STACK_VAR(_uniform,"_uniform");
			HX_STACK_LINE(96)
...
Void Shader_obj::set_float( ::String _name,Float _value){
{
		...
		if ((this->uniforms->exists(_name))){
			...
			struct _Function_2_1{
				inline static Dynamic Block( ::phoenix::Shader_obj *__this,::String &_name,Float &_value){
...
Void Shader_obj::set_vector2( ::String _name,::phoenix::Vector _value){
{
		...
		if ((this->uniforms->exists(_name))){
			...
			struct _Function_2_1{
				inline static Dynamic Block( ::phoenix::Shader_obj *__this,::String &_name,::phoenix::Vector &_value){
...
Void Shader_obj::set_color( ::String _name,::phoenix::Color _value){
{
		...
		if ((this->uniforms->exists(_name))){
			...
			struct _Function_2_1{
				inline static Dynamic Block( ::phoenix::Shader_obj *__this,::String &_name,::phoenix::Color &_value){
...
Void Shader_obj::set_texture( ::String _name,::phoenix::Texture _value){
{
		...
		if ((this->uniforms->exists(_name))){
			...
			struct _Function_2_1{
				inline static Dynamic Block( ::phoenix::Shader_obj *__this,::String &_name,::phoenix::Texture &_value){
	...
	HX_STACK_ARG(_verbose,"_verbose")
{
		...
		if ((_verbose)){
			HX_STACK_LINE(233)
			shader_log = ::snow::platform::native::render::opengl::GL_obj::getShaderInfoLog(_shader);
			HX_STACK_LINE(235)
		...
		HX_STACK_LINE(247)
		if (((::snow::platform::native::render::opengl::GL_obj::getShaderParameter(_shader,(int)35713) == (int)0))){
			HX_STACK_LINE(249)
...
Void Shader_obj::link( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(273)
		this->program = ::snow::platform::native::render::opengl::GL_obj::createProgram();
		HX_STACK_LINE(275)
		...
		HX_STACK_LINE(286)
		if (((::snow::platform::native::render::opengl::GL_obj::getProgramParameter(this->program,(int)35714) == (int)0))){
			HX_STACK_LINE(287)
			hx::AddEq(this->errors,HX_CSTRING("\tFailed to link shader program:"));
			HX_STACK_LINE(288)
			{
				HX_STACK_LINE(288)
				::String _error = (HX_CSTRING("\t\t") + ::snow::platform::native::render::opengl::GL_obj::getProgramInfoLog(this->program));		HX_STACK_VAR(_error,"_error");
				HX_STACK_LINE(288)
		...
		this->activate();
		HX_STACK_LINE(301)
		this->projectionmatrix_attribute = ::snow::platform::native::render::opengl::GL_obj::getUniformLocation(this->program,HX_CSTRING("projectionMatrix"));
		HX_STACK_LINE(302)
		this->modelviewmatrix_attribute = ::snow::platform::native::render::opengl::GL_obj::getUniformLocation(this->program,HX_CSTRING("modelViewMatrix"));
		HX_STACK_LINE(305)
		this->tex0_attribute = ::snow::platform::native::render::opengl::GL_obj::getUniformLocation(this->program,HX_CSTRING("tex0"));
		HX_STACK_LINE(306)
		this->tex1_attribute = ::snow::platform::native::render::opengl::GL_obj::getUniformLocation(this->program,HX_CSTRING("tex1"));
		HX_STACK_LINE(307)
		this->tex2_attribute = ::snow::platform::native::render::opengl::GL_obj::getUniformLocation(this->program,HX_CSTRING("tex2"));
		HX_STACK_LINE(308)
		this->tex3_attribute = ::snow::platform::native::render::opengl::GL_obj::getUniformLocation(this->program,HX_CSTRING("tex3"));
		HX_STACK_LINE(309)
		this->tex4_attribute = ::snow::platform::native::render::opengl::GL_obj::getUniformLocation(this->program,HX_CSTRING("tex4"));
		HX_STACK_LINE(310)
		this->tex5_attribute = ::snow::platform::native::render::opengl::GL_obj::getUniformLocation(this->program,HX_CSTRING("tex5"));
		HX_STACK_LINE(311)
		this->tex6_attribute = ::snow::platform::native::render::opengl::GL_obj::getUniformLocation(this->program,HX_CSTRING("tex6"));
		HX_STACK_LINE(312)
		this->tex7_attribute = ::snow::platform::native::render::opengl::GL_obj::getUniformLocation(this->program,HX_CSTRING("tex7"));
	}
return null();
}
	...
	HX_STACK_ARG(_verbose,"_verbose")
{
		...
		HX_STACK_LINE(396)
		this->vert_shader = this->compile((int)35633,this->vertex_source,_verbose);
		HX_STACK_LINE(397)
		this->frag_shader = this->compile((int)35632,this->frag_source,_verbose);
		HX_STACK_LINE(400)
	...
	HX_STACK_ARG(_silent,"_silent")
{
		...
		if (((bool((bool((bool((_frag_shader != null())) && bool((_frag_shader.length > (int)0)))) && bool((_vert_shader != null())))) && bool((_vert_shader.length > (int)0))))){
			...
			HX_STACK_LINE(360)
			_shader = ::phoenix::Shader_obj::__new(::Luxe_obj::resources);
			HX_STACK_LINE(361)
