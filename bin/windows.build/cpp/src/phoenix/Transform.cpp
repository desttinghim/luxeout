...
HX_STACK_FRAME("phoenix.Transform","new",0x37b5fb1f,"phoenix.Transform.new","phoenix/Transform.hx",11,0x44da8ab2)
{
	...
	HX_STACK_LINE(49)
	this->_origin_undo_matrix = ::phoenix::Matrix_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(50)
	this->_pos_matrix = ::phoenix::Matrix_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(51)
	this->_rotation_matrix = ::phoenix::Matrix_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(53)
	{
		HX_STACK_LINE(53)
			...
			if ((!(this->dirty))){
				...
				if (((this->parent != null()))){
					...
					if (((_m != null()))){
						...
						HX_STACK_LINE(180)
						_this->floats = ::snow::platform::native::utils::Float32Array_obj::__new(_this1->_float32array,null(),null());
					}
					HX_STACK_LINE(180)
					_this->matrix;
				}
					...
					if ((_this->auto_decompose)){
						...
						HX_STACK_LINE(180)
						{
							...
							if (((_this1->_transform == null()))){
								HX_STACK_LINE(180)
								_this1->_transform = ::phoenix::MatrixTransform_obj::__new(_position,_quaternion,_scale);
							}
							else{
								HX_STACK_LINE(180)
