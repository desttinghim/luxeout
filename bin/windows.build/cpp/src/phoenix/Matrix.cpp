...
Float n44 = __o_n44.Default(1);
{
	...
	HX_STACK_LINE(72)
	this->_float32array = ::snow::platform::native::utils::Float32Array_obj::__new(this->elements,null(),null());
}
;
	return null();
}
...
::String Matrix_obj::toString( ){
	...
	struct _Function_1_1{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",96,0x938b753d)
			{
				HX_STACK_LINE(96)
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(96)
				return (Float(::Std_obj::_int((e->__get((int)0) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g = ((HX_CSTRING("{ 11:") + _Function_1_1::Block(e)) + HX_CSTRING(", 12:"));
	HX_STACK_LINE(96)
	...
	struct _Function_1_2{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",96,0x938b753d)
			{
				...
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(96)
				return (Float(::Std_obj::_int((e->__get((int)4) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g1 = ((_g + _Function_1_2::Block(e)) + HX_CSTRING(", 13:"));
	HX_STACK_LINE(96)
	...
	struct _Function_1_3{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",96,0x938b753d)
			{
				...
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(96)
				return (Float(::Std_obj::_int((e->__get((int)8) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g2 = ((_g1 + _Function_1_3::Block(e)) + HX_CSTRING(", 14:"));
	HX_STACK_LINE(96)
	...
	struct _Function_1_4{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",96,0x938b753d)
			{
				...
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(96)
				return (Float(::Std_obj::_int((e->__get((int)12) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g3 = (((_g2 + _Function_1_4::Block(e)) + HX_CSTRING(" }, ")) + HX_CSTRING("{ 21:"));
	HX_STACK_LINE(96)
	::String _g4;		HX_STACK_VAR(_g4,"_g4");
	struct _Function_1_5{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",97,0x938b753d)
			{
				HX_STACK_LINE(97)
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(97)
				return (Float(::Std_obj::_int((e->__get((int)1) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g4 = ((_g3 + _Function_1_5::Block(e)) + HX_CSTRING(", 22:"));
	HX_STACK_LINE(96)
	...
	struct _Function_1_6{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",97,0x938b753d)
			{
				...
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(97)
				return (Float(::Std_obj::_int((e->__get((int)5) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g5 = ((_g4 + _Function_1_6::Block(e)) + HX_CSTRING(", 23:"));
	HX_STACK_LINE(96)
	...
	struct _Function_1_7{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",97,0x938b753d)
			{
				...
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(97)
				return (Float(::Std_obj::_int((e->__get((int)9) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g6 = ((_g5 + _Function_1_7::Block(e)) + HX_CSTRING(", 24:"));
	HX_STACK_LINE(96)
	...
	struct _Function_1_8{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",97,0x938b753d)
			{
				...
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(97)
				return (Float(::Std_obj::_int((e->__get((int)13) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g7 = (((_g6 + _Function_1_8::Block(e)) + HX_CSTRING(" }, ")) + HX_CSTRING("{ 31:"));
	HX_STACK_LINE(96)
	::String _g8;		HX_STACK_VAR(_g8,"_g8");
	struct _Function_1_9{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",98,0x938b753d)
			{
				HX_STACK_LINE(98)
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(98)
				return (Float(::Std_obj::_int((e->__get((int)2) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g8 = ((_g7 + _Function_1_9::Block(e)) + HX_CSTRING(", 32:"));
	HX_STACK_LINE(96)
	...
	struct _Function_1_10{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",98,0x938b753d)
			{
				...
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(98)
				return (Float(::Std_obj::_int((e->__get((int)6) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g9 = ((_g8 + _Function_1_10::Block(e)) + HX_CSTRING(", 33:"));
	HX_STACK_LINE(96)
	...
	struct _Function_1_11{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",98,0x938b753d)
			{
				...
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(98)
				return (Float(::Std_obj::_int((e->__get((int)10) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g10 = ((_g9 + _Function_1_11::Block(e)) + HX_CSTRING(", 34:"));
	HX_STACK_LINE(96)
	...
	struct _Function_1_12{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",98,0x938b753d)
			{
				...
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(98)
				return (Float(::Std_obj::_int((e->__get((int)14) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g11 = (((_g10 + _Function_1_12::Block(e)) + HX_CSTRING(" }, ")) + HX_CSTRING("{ 41:"));
	HX_STACK_LINE(96)
	::String _g12;		HX_STACK_VAR(_g12,"_g12");
	struct _Function_1_13{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",99,0x938b753d)
			{
				HX_STACK_LINE(99)
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(99)
				return (Float(::Std_obj::_int((e->__get((int)3) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g12 = ((_g11 + _Function_1_13::Block(e)) + HX_CSTRING(", 42:"));
	HX_STACK_LINE(96)
	...
	struct _Function_1_14{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",99,0x938b753d)
			{
				...
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(99)
				return (Float(::Std_obj::_int((e->__get((int)7) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g13 = ((_g12 + _Function_1_14::Block(e)) + HX_CSTRING(", 43:"));
	HX_STACK_LINE(96)
	...
	struct _Function_1_15{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",99,0x938b753d)
			{
				...
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(99)
				return (Float(::Std_obj::_int((e->__get((int)11) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	_g14 = ((_g13 + _Function_1_15::Block(e)) + HX_CSTRING(", 44:"));
	HX_STACK_LINE(96)
	...
	struct _Function_1_16{
		inline static Float Block( Array< Float > &e){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",99,0x938b753d)
			{
				...
				Float n = ::Math_obj::pow((int)10,(int)3);		HX_STACK_VAR(n,"n");
				HX_STACK_LINE(99)
				return (Float(::Std_obj::_int((e->__get((int)15) * n))) / Float(n));
			}
			return null();
		}
	};
	HX_STACK_LINE(96)
	str = ((_g14 + _Function_1_16::Block(e)) + HX_CSTRING(" }"));
	HX_STACK_LINE(100)
	return str;
}
...
::phoenix::Matrix Matrix_obj::extractRotation( ::phoenix::Matrix m){
	...
	Array< Float > me = m->elements;		HX_STACK_VAR(me,"me");
	HX_STACK_LINE(223)
	Float _scale_x;		HX_STACK_VAR(_scale_x,"_scale_x");
	struct _Function_1_1{
		inline static Float Block( ::phoenix::Vector &_temp,Array< Float > &me){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",223,0x938b753d)
			{
				HX_STACK_LINE(223)
	...
	HX_STACK_LINE(223)
	_scale_x = (Float((int)1) / Float(_Function_1_1::Block(_temp,me)));
	HX_STACK_LINE(224)
	Float _scale_y;		HX_STACK_VAR(_scale_y,"_scale_y");
	struct _Function_1_2{
		inline static Float Block( ::phoenix::Vector &_temp,Array< Float > &me){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",224,0x938b753d)
			{
				HX_STACK_LINE(224)
				::phoenix::Vector _this;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(224)
	...
	HX_STACK_LINE(224)
	_scale_y = (Float((int)1) / Float(_Function_1_2::Block(_temp,me)));
	HX_STACK_LINE(225)
	Float _scale_z;		HX_STACK_VAR(_scale_z,"_scale_z");
	struct _Function_1_3{
		inline static Float Block( ::phoenix::Vector &_temp,Array< Float > &me){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Matrix.hx",225,0x938b753d)
			{
				HX_STACK_LINE(225)
				::phoenix::Vector _this;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(225)
	...
	HX_STACK_LINE(225)
	_scale_z = (Float((int)1) / Float(_Function_1_3::Block(_temp,me)));
	HX_STACK_LINE(227)
...
::phoenix::Matrix Matrix_obj::lookAt( ::phoenix::Vector _eye,::phoenix::Vector _target,::phoenix::Vector _up){
	...
	HX_STACK_LINE(412)
	{
		...
		HX_STACK_LINE(412)
		{
			...
			HX_STACK_LINE(412)
			_z = ::phoenix::Vector_obj::__new((Float(_this->x) / Float(b)),(Float(_this->y) / Float(b)),(Float(_this->z) / Float(b)),null());
		}
	}
	HX_STACK_LINE(414)
	if (((::Math_obj::sqrt((((_z->x * _z->x) + (_z->y * _z->y)) + (_z->z * _z->z))) == (int)0))){
		HX_STACK_LINE(415)
		_z->z = (int)1;
		HX_STACK_LINE(415)
		if ((_z->_construct)){
	...
	HX_STACK_LINE(418)
	{
		...
		HX_STACK_LINE(418)
		{
			...
			Float b = ::Math_obj::sqrt((((_this->x * _this->x) + (_this->y * _this->y)) + (_this->z * _this->z)));		HX_STACK_VAR(b,"b");
			HX_STACK_LINE(418)
			_x = ::phoenix::Vector_obj::__new((Float(_this->x) / Float(b)),(Float(_this->y) / Float(b)),(Float(_this->z) / Float(b)),null());
		}
	}
	HX_STACK_LINE(420)
	if (((::Math_obj::sqrt((((_x->x * _x->x) + (_x->y * _x->y)) + (_x->z * _x->z))) == (int)0))){
		HX_STACK_LINE(421)
		{
			HX_STACK_LINE(421)
			...
			{
				HX_STACK_LINE(421)
				Float _x1 = (_g->x + 0.0001);		HX_STACK_VAR(_x1,"_x1");
				HX_STACK_LINE(421)
				_g->x = _x1;
				HX_STACK_LINE(421)
				if ((_g->_construct)){
	...
	HX_STACK_LINE(425)
	_y = ::phoenix::Vector_obj::__new(((_z->y * _x->z) - (_z->z * _x->y)),((_z->z * _x->x) - (_z->x * _x->z)),((_z->x * _x->y) - (_z->y * _x->x)),null());
	HX_STACK_LINE(427)
	te[(int)0] = _x->x;
	HX_STACK_LINE(427)
	te[(int)4] = _y->x;
...
Float Matrix_obj::getMaxScaleOnAxis( ){
	...
	HX_STACK_LINE(740)
	return ::Math_obj::sqrt(::Math_obj::max(_scaleXSq,::Math_obj::max(_scaleYSq,_scaleZSq)));
}
...
::phoenix::MatrixTransform Matrix_obj::decompose( ::phoenix::Vector _position,::phoenix::Quaternion _quaternion,::phoenix::Vector _scale){
	...
	if (((_quaternion == null()))){
		HX_STACK_LINE(896)
		_quaternion = ::phoenix::Quaternion_obj::__new(null(),null(),null(),null());
	}
	HX_STACK_LINE(899)
	if (((_position == null()))){
		HX_STACK_LINE(900)
		_position = ::phoenix::Vector_obj::__new(te->__get((int)12),te->__get((int)13),te->__get((int)14),null());
	}
	else{
		HX_STACK_LINE(902)
		{
	...
	if (((_scale == null()))){
		HX_STACK_LINE(908)
		_scale = ::phoenix::Vector_obj::__new(_ax_length,_ay_length,_az_length,null());
	}
	else{
		HX_STACK_LINE(910)
		{
	...
	if (((this->_transform == null()))){
		HX_STACK_LINE(936)
		this->_transform = ::phoenix::MatrixTransform_obj::__new(_position,_quaternion,_scale);
	}
	else{
		HX_STACK_LINE(938)
...
::phoenix::Matrix Matrix_obj::makePerspective( Float _fov,Float _aspect,Float _near,Float _far){
	...
	HX_STACK_ARG(_far,"_far")
	HX_STACK_LINE(972)
	Float ymax = (_near * ::Math_obj::tan(((_fov * 0.5) * 0.017453292519943278)));		HX_STACK_VAR(ymax,"ymax");
	HX_STACK_LINE(973)
...
{
		HX_STACK_FRAME("phoenix.Matrix","fromArray",0x486ebb41,"phoenix.Matrix.fromArray","phoenix/Matrix.hx",1005,0x938b753d)
		HX_STACK_THIS(this)
