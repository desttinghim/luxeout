...
HX_STACK_ARG(_type,"_type")
{
	...
	HX_STACK_LINE(62)
	this->_onload_handlers = Dynamic( Array_obj<Dynamic>::__new() );
	HX_STACK_LINE(64)
...
::String Texture_obj::toString( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(100)
	::String _g = ((((((((((HX_CSTRING("Texture (") + ::Std_obj::string(this->texture)) + HX_CSTRING(") (")) + this->width) + HX_CSTRING("x")) + this->height) + HX_CSTRING(") real size(")) + this->width_actual) + HX_CSTRING("x")) + this->height_actual) + HX_CSTRING(") "));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(100)
	::String _g1 = ((_g + ::Std_obj::string(this->filter)) + HX_CSTRING(" filtering. "));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(100)
	return (((_g1 + ::Std_obj::string(this->clamp)) + HX_CSTRING(" clamp. id: ")) + this->id);
}
...
Void Texture_obj::reset( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(268)
		this->texture = ::snow::platform::native::render::opengl::GL_obj::createTexture();
		HX_STACK_LINE(270)
		this->bind();
		HX_STACK_LINE(272)
...
Dynamic Texture_obj::get_pixel( ::phoenix::Vector _pos){
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::phoenix::Texture_obj *__this,int &x,int &y){
	...
	HX_STACK_ARG(_cache,"_cache")
{
		...
		if (((texture_bytes != null()))){
			struct _Function_2_1{
				inline static ::snow::platform::native::utils::ByteArray Block( ::haxe::io::Bytes &texture_bytes){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Texture.hx",181,0xc84e46a3)
					{
						HX_STACK_LINE(181)
			...
			HX_STACK_LINE(181)
			::phoenix::Texture texture = ::phoenix::Texture_obj::load_from_bytearray(_name,_Function_2_1::Block(texture_bytes),_cache);		HX_STACK_VAR(texture,"texture");
			HX_STACK_LINE(183)
			texture_bytes = null();
			HX_STACK_LINE(185)
			return texture;
