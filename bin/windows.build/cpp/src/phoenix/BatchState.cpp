...
HX_STACK_ARG(_r,"_r")
{
	...
	this->batcher = _r;
	HX_STACK_LINE(28)
	this->geom_state = ::phoenix::geometry::GeometryState_obj::__new();
	HX_STACK_LINE(29)
	this->last_geom_state = ::phoenix::geometry::GeometryState_obj::__new();
}
;
	return null();
}
		...
		if ((this->geom_state->clip)){
			...
			if (((this->clip_rect != null()))){
				...
				if ((!(this->clip_rect->equal(this->last_clip_rect)))){
					...
					HX_STACK_LINE(140)
					::snow::platform::native::render::opengl::GL_obj::scissor(_g,_g1,_g2,::Std_obj::_int(this->clip_rect->h));
				}
			}
		}
		else{
...
Void BatchState_obj::str( ){
{
		...
		if (((this->last_geom_state->texture == null()))){
			...
			HX_STACK_LINE(203)
			_g = this->last_geom_state->texture->id;
		}
		HX_STACK_LINE(203)
		::haxe::Log_obj::trace((HX_CSTRING("\t\ttexture - ") + _g),hx::SourceInfo(HX_CSTRING("BatchState.hx"),203,HX_CSTRING("phoenix.BatchState"),HX_CSTRING("str")));
		HX_STACK_LINE(204)
		if (((this->last_geom_state->texture != null()))){
			HX_STACK_LINE(205)
			::String _g1 = (HX_CSTRING("\t\t\t ") + ::Std_obj::string(this->last_geom_state->texture->texture));		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(205)
		...
		HX_STACK_LINE(207)
		if (((this->last_geom_state->shader == null()))){
			HX_STACK_LINE(207)
			_g2 = HX_CSTRING("null");
		}
		else{
			HX_STACK_LINE(207)
			_g2 = this->last_geom_state->shader->id;
		}
		HX_STACK_LINE(207)
		::haxe::Log_obj::trace((HX_CSTRING("\t\tshader - ") + _g2),hx::SourceInfo(HX_CSTRING("BatchState.hx"),207,HX_CSTRING("phoenix.BatchState"),HX_CSTRING("str")));
		HX_STACK_LINE(208)
		::String _g3 = (HX_CSTRING("\t\tprimitive_type - ") + ::Std_obj::string(this->last_geom_state->primitive_type));		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(208)
		::haxe::Log_obj::trace(_g3,hx::SourceInfo(HX_CSTRING("BatchState.hx"),208,HX_CSTRING("phoenix.BatchState"),HX_CSTRING("str")));
		HX_STACK_LINE(209)
		::String _g4 = (HX_CSTRING("\t\tclip - ") + ::Std_obj::string(this->last_geom_state->clip));		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(209)
		::haxe::Log_obj::trace(_g4,hx::SourceInfo(HX_CSTRING("BatchState.hx"),209,HX_CSTRING("phoenix.BatchState"),HX_CSTRING("str")));
		HX_STACK_LINE(210)
		...
		if (((this->geom_state->texture == null()))){
			...
			HX_STACK_LINE(215)
			_g5 = this->geom_state->texture->id;
		}
		HX_STACK_LINE(215)
		::haxe::Log_obj::trace((HX_CSTRING("\t\ttexture - ") + _g5),hx::SourceInfo(HX_CSTRING("BatchState.hx"),215,HX_CSTRING("phoenix.BatchState"),HX_CSTRING("str")));
		HX_STACK_LINE(216)
		if (((this->geom_state->texture != null()))){
			HX_STACK_LINE(217)
			::String _g6 = (HX_CSTRING("\t\t\t ") + ::Std_obj::string(this->geom_state->texture->texture));		HX_STACK_VAR(_g6,"_g6");
			HX_STACK_LINE(217)
			::haxe::Log_obj::trace(_g6,hx::SourceInfo(HX_CSTRING("BatchState.hx"),217,HX_CSTRING("phoenix.BatchState"),HX_CSTRING("str")));
		}
		HX_STACK_LINE(219)
		...
		if (((this->geom_state->shader == null()))){
			...
			HX_STACK_LINE(219)
			_g7 = this->geom_state->shader->id;
		}
		HX_STACK_LINE(219)
		::haxe::Log_obj::trace((HX_CSTRING("\t\tshader - ") + _g7),hx::SourceInfo(HX_CSTRING("BatchState.hx"),219,HX_CSTRING("phoenix.BatchState"),HX_CSTRING("str")));
		HX_STACK_LINE(220)
		::String _g8 = (HX_CSTRING("\t\tprimitive_type - ") + ::Std_obj::string(this->geom_state->primitive_type));		HX_STACK_VAR(_g8,"_g8");
		HX_STACK_LINE(220)
		::haxe::Log_obj::trace(_g8,hx::SourceInfo(HX_CSTRING("BatchState.hx"),220,HX_CSTRING("phoenix.BatchState"),HX_CSTRING("str")));
		HX_STACK_LINE(221)
		::String _g9 = (HX_CSTRING("\t\tclip - ") + ::Std_obj::string(this->geom_state->clip));		HX_STACK_VAR(_g9,"_g9");
		HX_STACK_LINE(221)
		::haxe::Log_obj::trace(_g9,hx::SourceInfo(HX_CSTRING("BatchState.hx"),221,HX_CSTRING("phoenix.BatchState"),HX_CSTRING("str")));
		HX_STACK_LINE(222)
