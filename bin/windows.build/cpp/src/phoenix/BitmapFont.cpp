...
HX_STACK_ARG(_options,"_options")
{
	...
	this->loaded = false;
	HX_STACK_LINE(80)
	this->id = (HX_CSTRING("font.") + ::Luxe_obj::utils->uniqueid(null()));
	HX_STACK_LINE(82)
	if (((_options == null()))){
		struct _Function_2_1{
			inline static Dynamic Block( ::phoenix::BitmapFont_obj *__this){
	...
	HX_STACK_LINE(87)
	this->pages = ::haxe::ds::IntMap_obj::__new();
}
;
	return null();
}
	...
	HX_STACK_ARG(_silent,"_silent")
{
		...
		HX_STACK_LINE(108)
		this->info = ::phoenix::_BitmapFont::Parser_obj::parse(_bitmapfont_data);
		HX_STACK_LINE(111)
		...
		HX_STACK_LINE(123)
		this->space_char = this->info->__Field(HX_CSTRING("chars"),true)->__Field(HX_CSTRING("get"),true)((int)32);
		HX_STACK_LINE(125)
		this->load_pages(_path,_custom_pages);
		HX_STACK_LINE(127)
		if (((::phoenix::BitmapFont_obj::generic_names->indexOf(this->id,null()) != (int)-1))){
			HX_STACK_LINE(128)
		...
		HX_STACK_LINE(164)
		{
			...
			for(::cpp::FastIterator_obj< int > *__it = ::cpp::CreateFastIterator< int >(::luxe::utils::unifill::CodePointIter_obj::__new(HX_CSTRING(" ")));  __it->hasNext(); ){
				int _uglyph = __it->next();
				{
					...
					if (((_index == (int)10))){
						HX_STACK_LINE(164)
						_max_w = ::Math_obj::max(_max_w,_cur_x1);
						HX_STACK_LINE(164)
						if ((_push_widths)){
							HX_STACK_LINE(164)
							Dynamic()(_cur_x1);
		...
		HX_STACK_LINE(179)
		{
			...
			while(((_g1 < _strings->length))){
				...
				struct _Function_3_1{
					inline static int Block( ::String &_str){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/BitmapFont.hx",180,0xdfcf0e40)
						{
							HX_STACK_LINE(180)
							int startIndex = (int)0;		HX_STACK_VAR(startIndex,"startIndex");
							struct _Function_4_1{
								inline static int Block( ::String &_str,int &startIndex){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/BitmapFont.hx",180,0xdfcf0e40)
									{
										HX_STACK_LINE(180)
										...
										HX_STACK_LINE(180)
										return (  (((startIndex >= (int)0))) ? int(_Function_5_1::Block(u,startIndex)) : int(_Function_5_2::Block(startIndex,u)) );
									}
									return null();
								}
							};
							HX_STACK_LINE(180)
							int index = _str.indexOf(HX_CSTRING("\n"),_Function_4_1::Block(_str,startIndex));		HX_STACK_VAR(index,"index");
							struct _Function_4_2{
								inline static int Block( ::String &_str,int &index){
									HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/BitmapFont.hx",180,0xdfcf0e40)
									{
										HX_STACK_LINE(180)
										::luxe::utils::unifill::Utf8 u = ::luxe::utils::unifill::Utf8_obj::__new(_str);		HX_STACK_VAR(u,"u");
							...
							HX_STACK_LINE(180)
							return (  (((index >= (int)0))) ? int(_Function_4_2::Block(_str,index)) : int((int)-1) );
						}
						return null();
					}
				};
				HX_STACK_LINE(180)
				if (((_Function_3_1::Block(_str) == (int)-1))){
					HX_STACK_LINE(181)
					if (((_str == HX_CSTRING("")))){
						HX_STACK_LINE(181)
						_str = HX_CSTRING(" ");
...
;
					...
					HX_STACK_LINE(186)
					{
						...
						while(((_g11 < _words->length))){
							HX_STACK_LINE(186)
							::String _word = _words->__get(_g11);		HX_STACK_VAR(_word,"_word");
							HX_STACK_LINE(186)
							++(_g11);
							HX_STACK_LINE(188)
							if (((_word != HX_CSTRING("")))){
	...
	HX_STACK_ARG(_custom_pages,"_custom_pages")
{
		...
		if (((_custom_pages == null()))){
			HX_STACK_LINE(391)
			this->items_total = ::Lambda_obj::count(this->info->__Field(HX_CSTRING("pages"),true),null());
			HX_STACK_LINE(393)
			{
				HX_STACK_LINE(393)
				int _g = (int)0;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(393)
				Dynamic _g1 = this->info->__Field(HX_CSTRING("pages"),true);		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(393)
				while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
					HX_STACK_LINE(393)
					Dynamic _page = Dynamic( Array_obj<Dynamic>::__new().Add(_g1->__GetItem(_g)));		HX_STACK_VAR(_page,"_page");
					HX_STACK_LINE(393)
					++(_g);
					HX_STACK_LINE(395)
