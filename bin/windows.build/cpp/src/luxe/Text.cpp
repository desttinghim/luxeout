...
HX_STACK_ARG(_options,"_options")
{
	...
	HX_STACK_LINE(91)
	this->geom = ::phoenix::geometry::TextGeometry_obj::__new(_Function_1_1::Block(_options,_batcher));
	HX_STACK_LINE(134)
	_options->__FieldRef(HX_CSTRING("geometry")) = this->geom;
	HX_STACK_LINE(135)
	_options->__FieldRef(HX_CSTRING("shader")) = this->geom->get_shader();
	HX_STACK_LINE(138)
...
Void Text_obj::set_pos_from_transform( ::phoenix::Vector _p){
{
		...
		HX_STACK_LINE(154)
		this->text_options->__FieldRef(HX_CSTRING("pos")) = this->get_pos();
	}
return null();
}
