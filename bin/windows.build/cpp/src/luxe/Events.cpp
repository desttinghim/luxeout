...
{
	HX_STACK_LINE(18)
	this->event_connections = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(19)
	this->event_slots = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(20)
	this->event_filters = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(21)
	this->event_queue = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(22)
	this->event_schedules = ::haxe::ds::StringMap_obj::__new();
}
;
	return null();
}
			...
			if ((this->does_filter_event(_filter_name,_event_name))){
				...
				HX_STACK_LINE(213)
				{
					...
					while(((_g < _filter->length))){
						HX_STACK_LINE(213)
						::luxe::_Events::EventConnection _connection = _filter->__get(_g).StaticCast< ::luxe::_Events::EventConnection >();		HX_STACK_VAR(_connection,"_connection");
						HX_STACK_LINE(213)
						++(_g);
						HX_STACK_LINE(214)
