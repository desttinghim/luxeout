...
::String Log_obj::_get_spacing( ::String _file){
	HX_STACK_FRAME("luxe.Log","_get_spacing",0xfd25c79d,"luxe.Log._get_spacing","luxe/Log.hx",212,0xe5312153)
	...
	HX_STACK_LINE(218)
	int _diff = (::luxe::Log_obj::_log_width - _trace_length);		HX_STACK_VAR(_diff,"_diff");
	HX_STACK_LINE(219)
	if (((_diff > (int)0))){
		HX_STACK_LINE(220)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("luxe.Log"), hx::TCanCast< Log_obj> ,sStaticFields,sMemberFields,
