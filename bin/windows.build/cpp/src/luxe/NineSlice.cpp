...
Void NineSlice_obj::update_size( Float _width,Float _height){
{
		...
		this->height = _height;
		HX_STACK_LINE(120)
		this->midwidth = ::Math_obj::abs(((this->width - this->left) - this->right));
		HX_STACK_LINE(121)
		this->midheight = ::Math_obj::abs(((this->height - this->top) - this->bottom));
		HX_STACK_LINE(124)
...
Void NineSlice_obj::set( Float _width,Float _height){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::NineSlice_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",223,0xccc9c257)
				{
					...
					__result->Add(HX_CSTRING("pos") , ::phoenix::Vector_obj::__new((int)0,(int)0,null(),null()),false);
		...
		HX_STACK_LINE(223)
		this->slices->__Field(HX_CSTRING("push"),true)(_Function_1_1::Block(this));
		struct _Function_1_2{
			inline static Dynamic Block( ::luxe::NineSlice_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",234,0xccc9c257)
				{
					...
					__result->Add(HX_CSTRING("source_y") , __this->source_y,false);
					__result->Add(HX_CSTRING("pos") , ::phoenix::Vector_obj::__new(__this->left,(int)0,null(),null()),false);
		...
		HX_STACK_LINE(234)
		this->slices->__Field(HX_CSTRING("push"),true)(_Function_1_2::Block(this));
		struct _Function_1_3{
			inline static Dynamic Block( ::luxe::NineSlice_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",245,0xccc9c257)
				{
					...
					__result->Add(HX_CSTRING("source_y") , __this->source_y,false);
					__result->Add(HX_CSTRING("pos") , ::phoenix::Vector_obj::__new((__this->left + __this->midwidth),(int)0,null(),null()),false);
		...
		HX_STACK_LINE(245)
		this->slices->__Field(HX_CSTRING("push"),true)(_Function_1_3::Block(this));
		struct _Function_1_4{
			inline static Dynamic Block( ::luxe::NineSlice_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",258,0xccc9c257)
				{
					...
					__result->Add(HX_CSTRING("pos") , ::phoenix::Vector_obj::__new((int)0,__this->top,null(),null()),false);
					__result->Add(HX_CSTRING("width") , __this->left,false);
		...
		HX_STACK_LINE(258)
		this->slices->__Field(HX_CSTRING("push"),true)(_Function_1_4::Block(this));
		struct _Function_1_5{
			inline static Dynamic Block( ::luxe::NineSlice_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",269,0xccc9c257)
				{
					...
					__result->Add(HX_CSTRING("source_x") , (__this->source_x + __this->left),false);
					__result->Add(HX_CSTRING("source_y") , (__this->source_y + __this->top),false);
					__result->Add(HX_CSTRING("pos") , ::phoenix::Vector_obj::__new(__this->left,__this->top,null(),null()),false);
					__result->Add(HX_CSTRING("width") , ((__this->width - __this->left) - __this->right),false);
					__result->Add(HX_CSTRING("height") , ((__this->height - __this->top) - __this->bottom),false);
					__result->Add(HX_CSTRING("geometry_id") , (int)0,false);
					return __result;
		...
		HX_STACK_LINE(269)
		this->slices->__Field(HX_CSTRING("push"),true)(_Function_1_5::Block(this));
		struct _Function_1_6{
			inline static Dynamic Block( ::luxe::NineSlice_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",280,0xccc9c257)
				{
					...
					__result->Add(HX_CSTRING("source_x") , (__this->source_x + ((__this->source_w - __this->right))),false);
					__result->Add(HX_CSTRING("source_y") , (__this->source_y + __this->top),false);
					__result->Add(HX_CSTRING("pos") , ::phoenix::Vector_obj::__new((__this->left + __this->midwidth),__this->top,null(),null()),false);
					__result->Add(HX_CSTRING("width") , __this->right,false);
					__result->Add(HX_CSTRING("height") , ((__this->height - __this->top) - __this->bottom),false);
					__result->Add(HX_CSTRING("geometry_id") , (int)0,false);
					return __result;
		...
		HX_STACK_LINE(280)
		this->slices->__Field(HX_CSTRING("push"),true)(_Function_1_6::Block(this));
		struct _Function_1_7{
			inline static Dynamic Block( ::luxe::NineSlice_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",293,0xccc9c257)
				{
					...
					__result->Add(HX_CSTRING("pos") , ::phoenix::Vector_obj::__new((int)0,(__this->top + __this->midheight),null(),null()),false);
					__result->Add(HX_CSTRING("width") , __this->left,false);
		...
		HX_STACK_LINE(293)
		this->slices->__Field(HX_CSTRING("push"),true)(_Function_1_7::Block(this));
		struct _Function_1_8{
			inline static Dynamic Block( ::luxe::NineSlice_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",304,0xccc9c257)
				{
					...
					__result->Add(HX_CSTRING("source_x") , (__this->source_x + __this->left),false);
					__result->Add(HX_CSTRING("source_y") , (__this->source_y + ((__this->source_h - __this->bottom))),false);
					__result->Add(HX_CSTRING("pos") , ::phoenix::Vector_obj::__new(__this->left,(__this->top + __this->midheight),null(),null()),false);
					__result->Add(HX_CSTRING("width") , ((__this->width - __this->left) - __this->right),false);
					__result->Add(HX_CSTRING("height") , __this->bottom,false);
					__result->Add(HX_CSTRING("geometry_id") , (int)0,false);
					return __result;
		...
		HX_STACK_LINE(304)
		this->slices->__Field(HX_CSTRING("push"),true)(_Function_1_8::Block(this));
		struct _Function_1_9{
			inline static Dynamic Block( ::luxe::NineSlice_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",315,0xccc9c257)
				{
					...
					__result->Add(HX_CSTRING("source_x") , (__this->source_x + ((__this->source_w - __this->right))),false);
					__result->Add(HX_CSTRING("source_y") , (__this->source_y + ((__this->source_h - __this->bottom))),false);
					__result->Add(HX_CSTRING("pos") , ::phoenix::Vector_obj::__new((__this->left + __this->midwidth),(__this->top + __this->midheight),null(),null()),false);
					__result->Add(HX_CSTRING("width") , __this->right,false);
					__result->Add(HX_CSTRING("height") , __this->bottom,false);
					__result->Add(HX_CSTRING("geometry_id") , (int)0,false);
					return __result;
		...
		HX_STACK_LINE(315)
		this->slices->__Field(HX_CSTRING("push"),true)(_Function_1_9::Block(this));
		HX_STACK_LINE(326)
		this->is_set = true;
	}
return null();
	...
	HX_STACK_LINE(336)
	{
		...
		while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
			...
			if (((this->_geometry != null()))){
				HX_STACK_LINE(338)
				this->_geometry->quad_resize(slice->__Field(HX_CSTRING("geometry_id"),true),::phoenix::Rectangle_obj::__new(slice->__Field(HX_CSTRING("pos"),true)->__Field(HX_CSTRING("x"),true),slice->__Field(HX_CSTRING("pos"),true)->__Field(HX_CSTRING("y"),true),slice->__Field(HX_CSTRING("width"),true),slice->__Field(HX_CSTRING("height"),true)));
			}
		}
	}
	HX_STACK_LINE(342)
	...
	HX_STACK_ARG(_reset,"_reset")
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::NineSlice_obj *__this,::phoenix::Color &_color){
		...
		HX_STACK_LINE(422)
		this->_geometry = ::phoenix::geometry::QuadPackGeometry_obj::__new(_Function_1_1::Block(this,_color));
		HX_STACK_LINE(431)
		{
			HX_STACK_LINE(431)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
			...
			while(((_g < _g1->__Field(HX_CSTRING("length"),true)))){
				...
				struct _Function_3_1{
					inline static Dynamic Block( ::luxe::NineSlice_obj *__this,Dynamic &slice){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/NineSlice.hx",433,0xccc9c257)
						{
							...
							__result->Add(HX_CSTRING("uv") , ::phoenix::Rectangle_obj::__new(slice->__Field(HX_CSTRING("source_x"),true),slice->__Field(HX_CSTRING("source_y"),true),slice->__Field(HX_CSTRING("source_width"),true),slice->__Field(HX_CSTRING("source_height"),true)),false);
							return __result;
						}
						return null();
					}
				...
				HX_STACK_LINE(433)
				slice->__FieldRef(HX_CSTRING("geometry_id")) = this->_geometry->quad_add(_Function_3_1::Block(this,slice));
			}
		}
		HX_STACK_LINE(446)
		{
