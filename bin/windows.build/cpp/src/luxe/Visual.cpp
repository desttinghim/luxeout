...
HX_STACK_ARG(_options,"_options")
{
	...
	HX_STACK_LINE(67)
	this->_rotation_euler = ::phoenix::Vector_obj::__new(null(),null(),null(),null());
	HX_STACK_LINE(68)
	this->_rotation_quat = ::phoenix::Quaternion_obj::__new(null(),null(),null(),null());
	HX_STACK_LINE(71)
	super::__construct(_options);
	HX_STACK_LINE(74)
	this->set_color(::phoenix::Color_obj::__new(null(),null(),null(),null()));
	HX_STACK_LINE(75)
	this->set_size(::phoenix::Vector_obj::__new(null(),null(),null(),null()));
	HX_STACK_LINE(78)
	...
	if (((this->options->__Field(HX_CSTRING("size"),true) != null()))){
		...
		if (((this->texture != null()))){
			...
			if ((this->texture->loaded)){
				HX_STACK_LINE(117)
				this->set_size(::phoenix::Vector_obj::__new(this->texture->width,this->texture->height,null(),null()));
				HX_STACK_LINE(118)
				this->_create_geometry();
			}
			else{
			...
			HX_STACK_LINE(130)
			this->set_size(::phoenix::Vector_obj::__new((int)64,(int)64,null(),null()));
			HX_STACK_LINE(132)
			this->_create_geometry();
		}
	}
		...
		if (((this->options->__Field(HX_CSTRING("geometry"),true) == null()))){
			...
			if (((bool((this->options->__Field(HX_CSTRING("no_geometry"),true) == null())) || bool((this->options->__Field(HX_CSTRING("no_geometry"),true) == false))))){
				...
				if (((this->options->__Field(HX_CSTRING("depth"),true) == null()))){
					...
					HX_STACK_LINE(170)
					_g1 = this->options->__Field(HX_CSTRING("depth"),true);
				}
				HX_STACK_LINE(171)
				...
				if (((this->options->__Field(HX_CSTRING("group"),true) == null()))){
					...
					HX_STACK_LINE(171)
					_g2 = this->options->__Field(HX_CSTRING("group"),true);
				}
				struct _Function_3_1{
					inline static Dynamic Block( ::luxe::Visual_obj *__this,Dynamic &_g1,::phoenix::Vector &_g,::phoenix::Batcher &_batcher,Dynamic &_g2){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/Visual.hx",159,0xe3547505)
						{
							...
							__result->Add(HX_CSTRING("depth") , _g1,false);
							__result->Add(HX_CSTRING("group") , _g2,false);
				...
				HX_STACK_LINE(159)
				this->set_geometry(::phoenix::geometry::QuadGeometry_obj::__new(_Function_3_1::Block(this,_g1,_g,_batcher,_g2)));
				HX_STACK_LINE(175)
				this->_creating_geometry = false;
				HX_STACK_LINE(178)
...
::phoenix::Texture Visual_obj::set_texture( ::phoenix::Texture _t){
	...
	HX_STACK_ARG(_t,"_t")
	HX_STACK_LINE(275)
	if (((  (((this->geometry != null()))) ? bool((this->geometry->get_texture() != _t)) : bool(false) ))){
		HX_STACK_LINE(276)
...
::phoenix::Shader Visual_obj::set_shader( ::phoenix::Shader _s){
	...
	HX_STACK_ARG(_s,"_s")
	HX_STACK_LINE(284)
	if (((  (((this->geometry != null()))) ? bool((this->geometry->get_shader() != _s)) : bool(false) ))){
		HX_STACK_LINE(285)
...
Void Visual_obj::set_rotation_from_transform( ::phoenix::Quaternion _rotation){
{
		...
		HX_STACK_LINE(363)
		{
			...
			if (((order == (int)0))){
				HX_STACK_LINE(363)
				_x = ::Math_obj::atan2(((int)2 * (((_rotation->x * _rotation->w) - (_rotation->y * _rotation->z)))),(((sqw - sqx) - sqy) + sqz));
				struct _Function_3_1{
				...
				HX_STACK_LINE(363)
				_y = ::Math_obj::asin(_Function_3_1::Block(_rotation));
				HX_STACK_LINE(363)
				_z = ::Math_obj::atan2(((int)2 * (((_rotation->z * _rotation->w) - (_rotation->x * _rotation->y)))),(((sqw + sqx) - sqy) - sqz));
			}
			else{
				HX_STACK_LINE(363)
				if (((order == (int)1))){
					...
					HX_STACK_LINE(363)
					_x = ::Math_obj::asin(_Function_4_1::Block(_rotation));
					HX_STACK_LINE(363)
					_y = ::Math_obj::atan2(((int)2 * (((_rotation->x * _rotation->z) + (_rotation->y * _rotation->w)))),(((sqw - sqx) - sqy) + sqz));
					HX_STACK_LINE(363)
					_z = ::Math_obj::atan2(((int)2 * (((_rotation->x * _rotation->y) + (_rotation->z * _rotation->w)))),(((sqw - sqx) + sqy) - sqz));
				}
				else{
					HX_STACK_LINE(363)
					if (((order == (int)2))){
						...
						HX_STACK_LINE(363)
						_x = ::Math_obj::asin(_Function_5_1::Block(_rotation));
						HX_STACK_LINE(363)
						_y = ::Math_obj::atan2(((int)2 * (((_rotation->y * _rotation->w) - (_rotation->z * _rotation->x)))),(((sqw - sqx) - sqy) + sqz));
						HX_STACK_LINE(363)
						_z = ::Math_obj::atan2(((int)2 * (((_rotation->z * _rotation->w) - (_rotation->x * _rotation->y)))),(((sqw - sqx) + sqy) - sqz));
					}
					else{
						...
						if (((order == (int)3))){
							HX_STACK_LINE(363)
							_x = ::Math_obj::atan2(((int)2 * (((_rotation->x * _rotation->w) + (_rotation->z * _rotation->y)))),(((sqw - sqx) - sqy) + sqz));
							...
							HX_STACK_LINE(363)
							_y = ::Math_obj::asin(_Function_6_1::Block(_rotation));
							HX_STACK_LINE(363)
							_z = ::Math_obj::atan2(((int)2 * (((_rotation->x * _rotation->y) + (_rotation->z * _rotation->w)))),(((sqw + sqx) - sqy) - sqz));
						}
						else{
							...
							if (((order == (int)4))){
								...
								_x = ::Math_obj::atan2(((int)2 * (((_rotation->x * _rotation->w) - (_rotation->z * _rotation->y)))),(((sqw - sqx) + sqy) - sqz));
								HX_STACK_LINE(363)
								_y = ::Math_obj::atan2(((int)2 * (((_rotation->y * _rotation->w) - (_rotation->x * _rotation->z)))),(((sqw + sqx) - sqy) - sqz));
								...
								HX_STACK_LINE(363)
								_z = ::Math_obj::asin(_Function_7_1::Block(_rotation));
							}
							else{
								HX_STACK_LINE(363)
								if (((order == (int)5))){
									...
									HX_STACK_LINE(363)
									_z = ::Math_obj::asin(_Function_8_1::Block(_rotation));
								}
							}
						}
					}
