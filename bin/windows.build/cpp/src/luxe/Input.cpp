...
Void Input_obj::init( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(239)
		this->key_bindings = ::haxe::ds::StringMap_obj::__new();
		HX_STACK_LINE(240)
		this->mouse_bindings = ::haxe::ds::StringMap_obj::__new();
		HX_STACK_LINE(242)
		this->_named_input_down = ::haxe::ds::StringMap_obj::__new();
		HX_STACK_LINE(243)
		this->_named_input_pressed = ::haxe::ds::StringMap_obj::__new();
		HX_STACK_LINE(244)
		this->_named_input_released = ::haxe::ds::StringMap_obj::__new();
		HX_STACK_LINE(138)
		Dynamic();
	}
return null();
