...
::luxe::utils::unifill::Utf8 Utf8_obj::charAt( int index){
	HX_STACK_FRAME("luxe.utils.unifill.Utf8","charAt",0x5e22fef6,"luxe.utils.unifill.Utf8.charAt","luxe/utils/unifill/Utf8.hx",58,0xbecfbbba)
	HX_STACK_THIS(this)
	HX_STACK_ARG(index,"index")
	struct _Function_1_1{
		inline static ::String Block( ::luxe::utils::unifill::Utf8_obj *__this,int &index){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/utils/unifill/Utf8.hx",58,0xbecfbbba)
			{
				HX_STACK_LINE(58)
				...
				{
					HX_STACK_LINE(58)
					int c = __this->str.cca(index);		HX_STACK_VAR(c,"c");
					HX_STACK_LINE(58)
					if (((c < (int)192))){
						HX_STACK_LINE(58)
						len = (int)1;
				...
				struct _Function_2_1{
					inline static ::String Block( ::luxe::utils::unifill::Utf8_obj *__this,Dynamic &len,int &index){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/utils/unifill/Utf8.hx",58,0xbecfbbba)
						{
							HX_STACK_LINE(58)
				...
				HX_STACK_LINE(58)
				return _Function_2_1::Block(__this,len,index);
			}
			return null();
		}
	};
	HX_STACK_LINE(58)
	return ::luxe::utils::unifill::Utf8_obj::__new(_Function_1_1::Block(this,index));
}
...
::luxe::utils::unifill::Utf8 Utf8_obj::substr( int index,Dynamic len){
	HX_STACK_FRAME("luxe.utils.unifill.Utf8","substr",0x40b874be,"luxe.utils.unifill.Utf8.substr","luxe/utils/unifill/Utf8.hx",108,0xbecfbbba)
	HX_STACK_THIS(this)
	HX_STACK_ARG(index,"index")
	...
	HX_STACK_LINE(108)
	return ::luxe::utils::unifill::Utf8_obj::__new(_Function_1_1::Block(this,len,index));
}
...
::luxe::utils::unifill::Utf8 Utf8_obj::fromCodePoint( int codePoint){
	...
	struct _Function_1_1{
		inline static ::String Block( ::haxe::io::BytesBuffer &buf){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/utils/unifill/Utf8.hx",14,0xbecfbbba)
			{
				HX_STACK_LINE(14)
				...
				HX_STACK_LINE(14)
				return _Function_2_1::Block(b);
			}
			return null();
		}
	};
	HX_STACK_LINE(14)
	return ::luxe::utils::unifill::Utf8_obj::__new(_Function_1_1::Block(buf));
}
...
::luxe::utils::unifill::Utf8 Utf8_obj::fromCodePoints( Dynamic codePoints){
	...
	struct _Function_1_1{
		inline static ::String Block( ::haxe::io::BytesBuffer &buf){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/utils/unifill/Utf8.hx",25,0xbecfbbba)
			{
				HX_STACK_LINE(25)
				::haxe::io::Bytes b = buf->getBytes();		HX_STACK_VAR(b,"b");
				struct _Function_2_1{
...
::luxe::utils::unifill::Utf8 Utf8_obj::fromBytes( ::haxe::io::Bytes b){
	HX_STACK_FRAME("luxe.utils.unifill.Utf8","fromBytes",0xbc27a334,"luxe.utils.unifill.Utf8.fromBytes","luxe/utils/unifill/Utf8.hx",33,0xbecfbbba)
	HX_STACK_ARG(b,"b")
	struct _Function_1_1{
		inline static ::String Block( ::haxe::io::Bytes &b){
	...
	HX_STACK_LINE(33)
	return ::luxe::utils::unifill::Utf8_obj::__new(_Function_1_1::Block(b));
}
