...
::String CodePoint_Impl__obj::cons( int a,::String b){
	...
	struct _Function_1_1{
		inline static ::String Block( int &a){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/utils/unifill/CodePoint.hx",7,0x1d0b0a0e)
			{
				HX_STACK_LINE(7)
						...
						inline static ::String Block( ::haxe::io::BytesBuffer &buf){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/utils/unifill/CodePoint.hx",7,0x1d0b0a0e)
							{
								...
								struct _Function_4_1{
									inline static ::String Block( ::haxe::io::Bytes &b1){
										HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/utils/unifill/CodePoint.hx",7,0x1d0b0a0e)
										{
											HX_STACK_LINE(7)
								...
								HX_STACK_LINE(7)
								return _Function_4_1::Block(b1);
							}
							return null();
						}
					};
					HX_STACK_LINE(7)
					_this = ::luxe::utils::unifill::Utf8_obj::__new(_Function_3_1::Block(buf));
				}
				HX_STACK_LINE(7)
				return _this->str;
			}
...
::String CodePoint_Impl__obj::snoc( ::String a,int b){
	...
	HX_STACK_ARG(b,"b")
	struct _Function_1_1{
		inline static ::String Block( int &b){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/utils/unifill/CodePoint.hx",11,0x1d0b0a0e)
			{
				HX_STACK_LINE(11)
				::luxe::utils::unifill::Utf8 _this;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(11)
...
::String CodePoint_Impl__obj::toString( int this1){
	...
	HX_STACK_LINE(40)
	{
		...
		struct _Function_2_1{
			inline static ::String Block( ::haxe::io::BytesBuffer &buf){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/utils/unifill/CodePoint.hx",40,0x1d0b0a0e)
				{
					HX_STACK_LINE(40)
