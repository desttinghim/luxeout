...
HX_STACK_ARG(s,"s")
{
	...
	this->s = s;
	HX_STACK_LINE(9)
	this->itr = ::luxe::utils::unifill::InternalEncodingIter_obj::__new(s,(int)0,s.length);
}
;
	return null();
}
...
int CodePointIter_obj::next( ){
	...
	struct _Function_1_1{
		inline static int Block( ::luxe::utils::unifill::CodePointIter_obj *__this){
				...
				HX_STACK_LINE(17)
				{
					...
					HX_STACK_LINE(17)
					{
						...
						HX_STACK_LINE(17)
						{
							...
							if (((c < (int)192))){
								HX_STACK_LINE(17)
								hx::AddEq(_this->index,(int)1);
							}
							else{
								HX_STACK_LINE(17)
								if (((c < (int)224))){
									HX_STACK_LINE(17)
									hx::AddEq(_this->index,(int)2);
								}
								else{
									HX_STACK_LINE(17)
									if (((c < (int)240))){
										HX_STACK_LINE(17)
										hx::AddEq(_this->index,(int)3);
									}
									else{
										HX_STACK_LINE(17)
										if (((c < (int)248))){
											HX_STACK_LINE(17)
											hx::AddEq(_this->index,(int)4);
										}
										else{
											HX_STACK_LINE(17)
											hx::AddEq(_this->index,(int)1);
