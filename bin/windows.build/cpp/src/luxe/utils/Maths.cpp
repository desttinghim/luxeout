...
Float Maths_obj::fixed( Float value,int precision){
	...
	HX_STACK_LINE(24)
	return (Float(::Std_obj::_int((value * n))) / Float(n));
}
...
Float Maths_obj::random16( ){
	...
	HX_STACK_LINE(118)
	Float _g = ((int)65280 * ::Math_obj::random());		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(118)
	return (Float(((_g + ((int)255 * ::Math_obj::random())))) / Float((int)65535));
}
...
int Maths_obj::random_int( int low,int high){
	HX_STACK_FRAME("luxe.utils.Maths","random_int",0xb762780b,"luxe.utils.Maths.random_int","luxe/utils/Maths.hx",122,0x6644526a)
	HX_STACK_ARG(low,"low")
	HX_STACK_ARG(high,"high")
	HX_STACK_LINE(122)
	return (low + ::Math_obj::floor((::Math_obj::random() * (((high - low) + (int)1)))));
}
...
Float Maths_obj::random_float( Float low,Float high){
	HX_STACK_FRAME("luxe.utils.Maths","random_float",0x736f2fb8,"luxe.utils.Maths.random_float","luxe/utils/Maths.hx",126,0x6644526a)
	HX_STACK_ARG(low,"low")
	HX_STACK_ARG(high,"high")
	HX_STACK_LINE(126)
	return (low + (::Math_obj::random() * ((high - low))));
}
...
Float Maths_obj::random_float_spread( Float range){
	HX_STACK_FRAME("luxe.utils.Maths","random_float_spread",0xf9b08b5a,"luxe.utils.Maths.random_float_spread","luxe/utils/Maths.hx",130,0x6644526a)
	HX_STACK_ARG(range,"range")
	HX_STACK_LINE(130)
	return (range * ((0.5 - ::Math_obj::random())));
}
