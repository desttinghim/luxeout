...
Float _smooth = __o__smooth.Default(6);
	HX_STACK_FRAME("luxe.utils.GeometryUtils","segments_for_smooth_circle",0xd8797010,"luxe.utils.GeometryUtils.segments_for_smooth_circle","luxe/utils/GeometryUtils.hx",23,0x749c9d76)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_radius,"_radius")
	HX_STACK_ARG(_smooth,"_smooth")
{
		HX_STACK_LINE(23)
		return ::Std_obj::_int((_smooth * ::Math_obj::sqrt(_radius)));
	}
}
...
::phoenix::Vector GeometryUtils_obj::random_point_in_unit_circle( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(30)
	Float _r = ::Math_obj::sqrt(::Math_obj::random());		HX_STACK_VAR(_r,"_r");
	HX_STACK_LINE(34)
	Float _t = ((((int)-1 + ((int)2 * ::Math_obj::random()))) * 6.283185307179586);		HX_STACK_VAR(_t,"_t");
	HX_STACK_LINE(37)
	Float _g = (_r * ::Math_obj::cos(_t));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(37)
	return ::phoenix::Vector_obj::__new(_g,(_r * ::Math_obj::sin(_t)),null(),null());
}
...
bool GeometryUtils_obj::point_in_polygon( ::phoenix::Vector _point,::phoenix::Vector _offset,Array< ::Dynamic > _verts){
	...
	if (((_offset == null()))){
		HX_STACK_LINE(43)
		_offset = ::phoenix::Vector_obj::__new(null(),null(),null(),null());
	}
	HX_STACK_LINE(44)
