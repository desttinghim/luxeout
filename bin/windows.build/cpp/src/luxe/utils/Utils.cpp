...
HX_STACK_ARG(_luxe,"_luxe")
{
	...
	this->core = _luxe;
	HX_STACK_LINE(23)
	this->geometry = ::luxe::utils::GeometryUtils_obj::__new(this->core);
	HX_STACK_LINE(25)
...
::String Utils_obj::uniqueid( Dynamic val){
	...
	if (((val == null()))){
		HX_STACK_LINE(35)
		val = ::Std_obj::random((int)2147483647);
	}
	...
	if (((q > (int)0))){
		HX_STACK_LINE(47)
		::String _g = this->uniqueid(q);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(47)
		return (_g + to_char(r).Cast< ::String >());
	}
	else{
		HX_STACK_LINE(48)
		return ::Std_obj::string(to_char(r).Cast< ::String >());
	}
	HX_STACK_LINE(47)
	return null();
}
...
int Utils_obj::uniquehash( ){
	HX_STACK_FRAME("luxe.utils.Utils","uniquehash",0x7fb8eb31,"luxe.utils.Utils.uniquehash","luxe/utils/Utils.hx",56,0x2d9d0da4)
	HX_STACK_THIS(this)
	HX_STACK_LINE(56)
	return this->hash(this->uniqueid(null()));
}
...
{
		HX_STACK_LINE(69)
		int this1 = ::luxe::utils::Murmur3_obj::hash(_bytes,_seed);		HX_STACK_VAR(this1,"this1");
		HX_STACK_LINE(69)
		return this1;
	}
}
...
int Utils_obj::hashdjb2( ::String string){
	...
	HX_STACK_LINE(78)
	{
		...
		while(((_g1 < _g))){
			...
			HX_STACK_LINE(79)
			_hash = ((((int(_hash) << int((int)5))) + _hash) + string.charCodeAt(i));
		}
	}
	HX_STACK_LINE(82)
	return _hash;
...
::String Utils_obj::uniqueid2( ){
	...
	HX_STACK_LINE(89)
	return ::haxe::crypto::Md5_obj::encode(::Std_obj::string((_g * ::Math_obj::random())));
}
	...
	HX_STACK_ARG(_depth,"_depth")
{
		...
		stack->reverse();
		HX_STACK_LINE(110)
		int total = ::Std_obj::_int(::Math_obj::min(stack->length,_depth));		HX_STACK_VAR(total,"total");
		HX_STACK_LINE(112)
		{
			HX_STACK_LINE(112)
			...
			while(((_g < total))){
				...
				{
					HX_STACK_LINE(115)
					::haxe::StackItem _g1 = stack->__get(i).StaticCast< ::haxe::StackItem >();		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(115)
					switch( (int)(_g1->__Index())){
						case (int)2: {
							HX_STACK_LINE(115)
							int line = (::haxe::StackItem(_g1))->__Param(2);		HX_STACK_VAR(line,"line");
							HX_STACK_LINE(115)
							::String file = (::haxe::StackItem(_g1))->__Param(1);		HX_STACK_VAR(file,"file");
							HX_STACK_LINE(115)
							::haxe::StackItem s = (::haxe::StackItem(_g1))->__Param(0);		HX_STACK_VAR(s,"s");
							HX_STACK_LINE(117)
...
bool Utils_obj::path_is_relative( ::String _path){
	HX_STACK_FRAME("luxe.utils.Utils","path_is_relative",0x5216f779,"luxe.utils.Utils.path_is_relative","luxe/utils/Utils.hx",137,0x2d9d0da4)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_path,"_path")
	HX_STACK_LINE(137)
	if (((  (((  (((  (((_path.charAt((int)0) != HX_CSTRING("#")))) ? bool((_path.charAt((int)0) != HX_CSTRING("/"))) : bool(false) ))) ? bool((_path.indexOf(HX_CSTRING(":\\"),null()) == (int)-1)) : bool(false) ))) ? bool((_path.indexOf(HX_CSTRING(":/"),null()) == (int)-1)) : bool(false) ))){
		struct _Function_2_1{
			inline static bool Block( ::String &_path){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/utils/Utils.hx",143,0x2d9d0da4)
				{
					HX_STACK_LINE(143)
					int _g = _path.indexOf(HX_CSTRING("//"),null());		HX_STACK_VAR(_g,"_g");
					HX_STACK_LINE(143)
					return (_g > _path.indexOf(HX_CSTRING("#"),null()));
				}
				return null();
			}
		};
		HX_STACK_LINE(142)
		if ((!(((  ((!(((_path.indexOf(HX_CSTRING("//"),null()) == (int)-1))))) ? bool(_Function_2_1::Block(_path)) : bool(true) ))))){
			HX_STACK_LINE(144)
			int _g1 = _path.indexOf(HX_CSTRING("//"),null());		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(144)
			return (_g1 > _path.indexOf(HX_CSTRING("?"),null()));
		}
		else{
			HX_STACK_LINE(142)
			return true;
		...
		HX_STACK_LINE(231)
		{
			...
			while(((_g2 < _g1))){
				...
				struct _Function_3_1{
					inline static int Block( int &i,Array< ::Dynamic > &lengths,int &k){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/utils/Utils.hx",236,0x2d9d0da4)
						{
							HX_STACK_LINE(236)
							...
							HX_STACK_LINE(236)
							return (total + (((i - k) + (int)1)));
						}
						return null();
					}
				};
				HX_STACK_LINE(236)
				while(((  (((_Function_3_1::Block(i,lengths,k) <= _column))) ? bool((k > (int)0)) : bool(false) ))){
					HX_STACK_LINE(237)
					int a;		HX_STACK_VAR(a,"a");
					struct _Function_4_1{
						inline static int Block( int &i,Array< ::Dynamic > &lengths,int &k){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/utils/Utils.hx",237,0x2d9d0da4)
							{
								HX_STACK_LINE(237)
								int total = (int)0;		HX_STACK_VAR(total,"total");
								HX_STACK_LINE(237)
					...
					HX_STACK_LINE(237)
					a = (_column - _Function_4_1::Block(i,lengths,k));
					HX_STACK_LINE(238)
					{
						HX_STACK_LINE(238)
						Float _g = ::Math_obj::pow(a,(int)3);		HX_STACK_VAR(_g,"_g");
						HX_STACK_LINE(238)
						int k1 = ::Std_obj::_int((_g + badness->get((k - (int)1))));		HX_STACK_VAR(k1,"k1");
						HX_STACK_LINE(238)
						sums->set(k1,k);
						HX_STACK_LINE(238)
						k;
...
;
		...
		while(((n > (int)1))){
			HX_STACK_LINE(250)
			result->unshift(words->slice((extra->get(n) - (int)1),n)->join(HX_CSTRING(" ")));
			HX_STACK_LINE(251)
			n = (extra->get(n) - (int)1);
			HX_STACK_LINE(252)
			hx::AddEq(line,(int)1);
...
::String Utils_obj::bytes_to_string( int bytes){
	...
	HX_STACK_LINE(277)
	int index = ::Math_obj::floor((Float(_g) / Float(::Math_obj::log((int)1024))));		HX_STACK_VAR(index,"index");
	HX_STACK_LINE(278)
	Float _byte_value = (Float(bytes) / Float(::Math_obj::pow((int)1024,index)));		HX_STACK_VAR(_byte_value,"_byte_value");
	HX_STACK_LINE(280)
