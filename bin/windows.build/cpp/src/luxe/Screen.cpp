...
HX_STACK_ARG(_h,"_h")
{
	...
	this->core = _core;
	HX_STACK_LINE(22)
	this->cursor = ::luxe::Cursor_obj::__new(hx::ObjectPtr<OBJ_>(this));
	HX_STACK_LINE(24)
	this->x = _x;
	HX_STACK_LINE(25)
	this->y = _y;
	...
	this->h = _h;
	HX_STACK_LINE(29)
	int _g = ::Math_obj::round((Float(this->w) / Float((int)2)));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(29)
	this->mid = ::phoenix::Vector_obj::__new(_g,::Math_obj::round((Float(this->h) / Float((int)2))),null(),null());
	HX_STACK_LINE(30)
	this->size = ::phoenix::Vector_obj::__new(this->w,this->h,null(),null());
}
;
	return null();
}
