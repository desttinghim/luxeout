...
{
HX_STACK_FRAME("luxe.tween.LinearPath","new",0xd2e8f697,"luxe.tween.LinearPath.new","luxe/tween/MotionPath.hx",232,0x24788886)
...
Float LinearPath_obj::calculate( Float start,Float k){
	HX_STACK_FRAME("luxe.tween.LinearPath","calculate",0x947cbedd,"luxe.tween.LinearPath.calculate","luxe/tween/MotionPath.hx",239,0x24788886)
	HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("luxe.tween.LinearPath"), hx::TCanCast< LinearPath_obj> ,sStaticFields,sMemberFields,
