	...
	HX_STACK_ARG(allowCreation,"allowCreation")
{
		struct _Function_1_1{
			inline static bool Block( Dynamic &target){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/tween/Actuate.hx",50,0x5242ff4c)
				{
					...
					HX_STACK_LINE(50)
					return ::luxe::tween::Actuate_obj::targetLibraries->__Internal->exists(::__hxcpp_obj_id(key));
				}
				return null();
			}
		};
		...
		if (((  ((!(_Function_1_1::Block(target)))) ? bool(allowCreation) : bool(false) ))){
			HX_STACK_LINE(52)
			::luxe::tween::Actuate_obj::targetLibraries->set(target,Array_obj< ::Dynamic >::__new());
		}
		HX_STACK_LINE(56)
...
;
		...
		HX_STACK_LINE(136)
		::luxe::tween::Actuate_obj::targetLibraries = ::haxe::ds::ObjectMap_obj::__new();
	}
return null();
}
...
::luxe::tween::actuators::IGenericActuator Actuate_obj::timer( Float duration,::Class customActuator){
	...
	HX_STACK_LINE(250)
	return ::luxe::tween::Actuate_obj::tween(_g,duration,::luxe::tween::_Actuate::TweenTimer_obj::__new((int)1),false,customActuator);
}
		...
		if (((target != null()))){
			...
			if (((duration > (int)0))){
				...
				if ((overwrite)){
					...
					HX_STACK_LINE(290)
					library = ::luxe::tween::Actuate_obj::getLibrary(actuator->target,null());
				}
				HX_STACK_LINE(294)
...
Void Actuate_obj::unload( ::luxe::tween::actuators::GenericActuator actuator){
{
		...
		HX_STACK_LINE(329)
		if ((::luxe::tween::Actuate_obj::targetLibraries->__Internal->exists(::__hxcpp_obj_id(target)))){
			HX_STACK_LINE(331)
