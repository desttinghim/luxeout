...
HX_STACK_ARG(properties,"properties")
{
	...
	HX_STACK_LINE(54)
	this->startTime = ::Luxe_obj::get_time();
	HX_STACK_LINE(56)
			...
			while(((_g < _g1->length))){
				...
				if ((::Std_obj::is(start,hx::ClassOf< ::Float >()))){
					struct _Function_4_1{
						inline static Dynamic Block( ::String &i,::luxe::tween::actuators::SimpleActuator_obj *__this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/tween/actuators/SimpleActuator.hx",156,0x1966fbc1)
							{
								HX_STACK_LINE(156)
					...
					HX_STACK_LINE(156)
					details = ::luxe::tween::actuators::PropertyDetails_obj::__new(this->target,i,start,(_Function_4_1::Block(i,this) - start),isField);
					HX_STACK_LINE(157)
...
Void SimpleActuator_obj::move( ){
{
		...
		if ((::Reflect_obj::hasField(this->properties,HX_CSTRING("alpha")))){
			HX_STACK_LINE(171)
			this->toggleVisible = ::Reflect_obj::hasField(this->properties,HX_CSTRING("visible"));
		}
		else{
			HX_STACK_LINE(171)
			this->toggleVisible = false;
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::tween::actuators::SimpleActuator_obj *__this){
		...
		if ((!(this->paused))){
			...
			if (((tweenPosition == (int)1))){
				...
				if (((this->_repeat == (int)0))){
					...
					HX_STACK_LINE(401)
					if (((  ((this->toggleVisible)) ? bool((_Function_4_1::Block(this) == (int)0)) : bool(false) ))){
						HX_STACK_LINE(403)
						Dynamic target = this->target;		HX_STACK_VAR(target,"target");
						HX_STACK_LINE(403)
						if ((::Reflect_obj::hasField(target,HX_CSTRING("visible")))){
...
Void SimpleActuator_obj::on_internal_update( Float dt){
{
		...
		HX_STACK_LINE(457)
		::luxe::tween::actuators::SimpleActuator_obj::current_time = ::Luxe_obj::get_time();
		HX_STACK_LINE(459)
		...
		HX_STACK_LINE(466)
		{
			...
			int _g1 = (int)0;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(466)
			int _g = ::luxe::tween::actuators::SimpleActuator_obj::actuatorsLength;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(466)
			while(((_g1 < _g))){
				HX_STACK_LINE(466)
