...
HX_STACK_ARG(_options,"_options")
{
	...
	HX_STACK_LINE(96)
	super::__construct((  (((_name == HX_CSTRING("")))) ? ::String(::Luxe_obj::utils->uniqueid(null())) : ::String(_name) ),null());
}
;
	return null();
}
...
{
		HX_STACK_FRAME("luxe.Component","_detach_entity",0xc314e079,"luxe.Component._detach_entity","luxe/Component.hx",133,0xa970277a)
		HX_STACK_THIS(this)
		HX_STACK_LINE(133)
...
{
		HX_STACK_FRAME("luxe.Component","_attach_entity",0xcc0ad447,"luxe.Component._attach_entity","luxe/Component.hx",141,0xa970277a)
		HX_STACK_THIS(this)
		HX_STACK_LINE(141)
		if (((this->get_entity() != null()))){
		}
