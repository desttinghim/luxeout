...
::String _name = __o__name.Default(HX_CSTRING("untitled scene"));
{
	...
	HX_STACK_LINE(27)
	this->entities = ::haxe::ds::StringMap_obj::__new();
	HX_STACK_LINE(29)
...
bool Scene_obj::remove( ::luxe::Entity entity){
	...
	HX_STACK_LINE(106)
	if (((entity->get_scene() == hx::ObjectPtr<OBJ_>(this)))){
		HX_STACK_LINE(108)
...
::String Scene_obj::toString( ){
	HX_STACK_FRAME("luxe.Scene","toString",0xab9df5e6,"luxe.Scene.toString","luxe/Scene.hx",442,0x14d4e1cb)
	HX_STACK_THIS(this)
	HX_STACK_LINE(442)
	return (((((HX_CSTRING("luxe Scene: ") + this->name) + HX_CSTRING(" / ")) + this->get_length()) + HX_CSTRING(" entities / id: ")) + this->id);
}
