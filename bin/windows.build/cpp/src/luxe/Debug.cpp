...
Void Debug_obj::init( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(64)
		::luxe::Debug_obj::trace_callbacks = ::haxe::ds::StringMap_obj::__new();
		HX_STACK_LINE(68)
		::luxe::debug::TraceDebugView _g = ::luxe::debug::TraceDebugView_obj::__new();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(69)
		::luxe::debug::StatsDebugView _g1 = ::luxe::debug::StatsDebugView_obj::__new();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(67)
		::luxe::Debug_obj::views = Array_obj< ::Dynamic >::__new().Add(_g).Add(_g1).Add(::luxe::debug::ProfilerDebugView_obj::__new());
		HX_STACK_LINE(77)
...
Void Debug_obj::create_debug_console( ){
{
		...
		HX_STACK_LINE(165)
		this->batcher = ::phoenix::Batcher_obj::__new(::Luxe_obj::renderer,HX_CSTRING("debug_batcher"));
		HX_STACK_LINE(167)
		this->view = ::phoenix::Camera_obj::__new(null());
		HX_STACK_LINE(169)
		...
		HX_STACK_LINE(177)
		::luxe::Screen _g11 = ::Luxe_obj::get_screen();		HX_STACK_VAR(_g11,"_g11");
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::Screen &_g1,::luxe::Screen &_g11,::luxe::Debug_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/Debug.hx",175,0xe4198724)
				{
					...
					__result->Add(HX_CSTRING("w") , _g1->w,false);
					__result->Add(HX_CSTRING("h") , _g11->h,false);
					__result->Add(HX_CSTRING("color") , ::phoenix::Color_obj::__new((int)0,(int)0,(int)0,0.8),false);
		...
		HX_STACK_LINE(175)
		this->overlay = ::phoenix::geometry::QuadGeometry_obj::__new(_Function_1_1::Block(_g1,_g11,this));
		HX_STACK_LINE(186)
		::luxe::Screen _g2 = ::Luxe_obj::get_screen();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(186)
		this->padding = ::phoenix::Vector_obj::__new((_g2->w * 0.05),(::Luxe_obj::get_screen()->h * 0.05),null(),null());
		HX_STACK_LINE(189)
		::phoenix::Vector _g3 = ::phoenix::Vector_obj::__new(this->padding->x,this->padding->y,null(),null());		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(190)
		::luxe::Screen _g4 = ::Luxe_obj::get_screen();		HX_STACK_VAR(_g4,"_g4");
		struct _Function_1_2{
			inline static Dynamic Block( ::luxe::Debug_obj *__this,::luxe::Screen &_g4,::phoenix::Vector &_g3){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/Debug.hx",187,0xe4198724)
				{
					...
					__result->Add(HX_CSTRING("size") , ::phoenix::Vector_obj::__new((_g4->w - (__this->padding->x * (int)2)),(::Luxe_obj::get_screen()->h - (__this->padding->y * (int)2)),null(),null()),false);
					__result->Add(HX_CSTRING("batcher") , __this->batcher,false);
					return __result;
				}
				return null();
		...
		HX_STACK_LINE(187)
		this->debug_inspector = ::luxe::debug::Inspector_obj::__new(_Function_1_2::Block(this,_g4,_g3));
		HX_STACK_LINE(194)
		...
		HX_STACK_LINE(209)
		{
			...
			while(((_g5 < _g12->length))){
				HX_STACK_LINE(209)
				::luxe::debug::DebugView view = _g12->__get(_g5).StaticCast< ::luxe::debug::DebugView >();		HX_STACK_VAR(view,"view");
				HX_STACK_LINE(209)
				++(_g5);
				HX_STACK_LINE(210)
				view->create();
...
Void Debug_obj::onresize( Dynamic e){
{
		...
		HX_STACK_LINE(296)
		this->view->set_viewport(::phoenix::Rectangle_obj::__new((int)0,(int)0,_g->w,::Luxe_obj::get_screen()->h));
	}
return null();
}
	...
	HX_STACK_ARG(_show,"_show")
{
		...
		if ((_show)){
			HX_STACK_LINE(337)
			this->last_cursor_shown = ::Luxe_obj::get_screen()->cursor->get_visible();
			HX_STACK_LINE(338)
			this->last_cursor_grab = ::Luxe_obj::get_screen()->cursor->get_grab();
			HX_STACK_LINE(340)
...
Void Debug_obj::process( ){
{
		...
		struct _Function_1_1{
			inline static Float Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/Debug.hx",399,0xe4198724)
				{
					HX_STACK_LINE(399)
					Float n = ::Math_obj::pow((int)10,(int)5);		HX_STACK_VAR(n,"n");
					HX_STACK_LINE(399)
					return (Float(::Std_obj::_int((::Luxe_obj::core->delta_time * n))) / Float(n));
				}
				return null();
			}
		};
		HX_STACK_LINE(399)
		_g = ((((HX_CSTRING("[ ") + this->current_view->name) + HX_CSTRING(" ] ")) + _Function_1_1::Block()) + HX_CSTRING(" / "));
		struct _Function_1_2{
			inline static Float Block( ::luxe::Debug_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/Debug.hx",399,0xe4198724)
				{
					HX_STACK_LINE(399)
					Float n = ::Math_obj::pow((int)10,(int)5);		HX_STACK_VAR(n,"n");
					HX_STACK_LINE(399)
					return (Float(::Std_obj::_int((__this->dt_average * n))) / Float(n));
				}
				return null();
			}
		};
		HX_STACK_LINE(399)
		this->debug_inspector->_title_text->set_text((_g + _Function_1_2::Block(this)));
		HX_STACK_LINE(402)
		{
			HX_STACK_LINE(402)
			...
			while(((_g1 < _g11->length))){
				HX_STACK_LINE(402)
				::luxe::debug::DebugView view = _g11->__get(_g1).StaticCast< ::luxe::debug::DebugView >();		HX_STACK_VAR(view,"view");
				HX_STACK_LINE(402)
				++(_g1);
				HX_STACK_LINE(403)
				view->process();
...
Void Debug_obj::internal_trace( Dynamic v,Dynamic inf){
{
		...
		HX_STACK_LINE(133)
		::String _line = ::StringTools_obj::rpad(::Std_obj::string(inf->__Field(HX_CSTRING("lineNumber"),true)),HX_CSTRING(" "),(int)4);		HX_STACK_VAR(_line,"_line");
		HX_STACK_LINE(135)
