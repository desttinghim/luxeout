...
::phoenix::geometry::Geometry Draw_obj::ngon( Dynamic options){
	...
	if ((_solid)){
		HX_STACK_LINE(129)
		_geometry->add(::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new(_x,_y,null(),null()),options->__Field(HX_CSTRING("color"),true),null()));
	}
	HX_STACK_LINE(132)
	...
	HX_STACK_LINE(135)
	{
		...
		while(((_g < _count))){
			...
			HX_STACK_LINE(137)
			Float __x = (_radius * ::Math_obj::sin(((_angle_rad + _sides_over_pi) + (i * _sides_over_twopi))));		HX_STACK_VAR(__x,"__x");
			HX_STACK_LINE(138)
			Float __y = (_radius * ::Math_obj::cos(((_angle_rad + _sides_over_pi) + (i * _sides_over_twopi))));		HX_STACK_VAR(__y,"__y");
			HX_STACK_LINE(139)
			::phoenix::Vector __pos = ::phoenix::Vector_obj::__new((_x + __x),(_y + __y),(int)0,null());		HX_STACK_VAR(__pos,"__pos");
			HX_STACK_LINE(141)
			_geometry->add(::phoenix::geometry::Vertex_obj::__new(__pos,options->__Field(HX_CSTRING("color"),true),null()));
			HX_STACK_LINE(143)
			if ((!(_solid))){
				HX_STACK_LINE(144)
				if (((i > (int)0))){
	...
	if ((!(_solid))){
		HX_STACK_LINE(155)
		_geometry->add(::phoenix::geometry::Vertex_obj::__new(_points->__get((int)0).StaticCast< ::phoenix::Vector >(),options->__Field(HX_CSTRING("color"),true),null()));
	}
	HX_STACK_LINE(158)
	return _geometry;
}
...
::phoenix::geometry::QuadGeometry Draw_obj::texture( Dynamic options){
	...
	HX_STACK_LINE(226)
	_quad->uv(::phoenix::Rectangle_obj::__new(_ux,_uy,_uw,_uh));
	HX_STACK_LINE(228)
	return _quad;
}
