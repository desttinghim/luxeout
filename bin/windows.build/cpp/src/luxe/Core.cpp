...
HX_STACK_ARG(_game,"_game")
{
	...
	HX_STACK_LINE(118)
	this->core_thread = ::cpp::vm::Thread_obj::current();
	HX_STACK_LINE(122)
	this->emitter = ::luxe::Emitter_obj::__new();
	HX_STACK_LINE(124)
	this->_mouse_pos = ::phoenix::Vector_obj::__new(null(),null(),null(),null());
	HX_STACK_LINE(125)
	this->_touch_pos = ::phoenix::Vector_obj::__new(null(),null(),null(),null());
	HX_STACK_LINE(126)
	::Luxe_obj::mouse = this->_mouse_pos;
	HX_STACK_LINE(129)
	::Luxe_obj::core = hx::ObjectPtr<OBJ_>(this);
	HX_STACK_LINE(130)
	::Luxe_obj::utils = ::luxe::utils::Utils_obj::__new(hx::ObjectPtr<OBJ_>(this));
}
;
	return null();
}
...
Void Core_obj::ready( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(138)
		::Luxe_obj::version = ::haxe::Resource_obj::getString(HX_CSTRING("version"));
		HX_STACK_LINE(140)
		::Luxe_obj::build = (::Luxe_obj::version + ::haxe::Resource_obj::getString(HX_CSTRING("build")));
		HX_STACK_LINE(142)
...
Void Core_obj::init( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(222)
		this->debug = ::luxe::Debug_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(223)
		::Luxe_obj::debug = this->debug;
		HX_STACK_LINE(225)
		this->draw = ::luxe::Draw_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(226)
		this->timer = ::luxe::Timer_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(227)
		this->events = ::luxe::Events_obj::__new();
		HX_STACK_LINE(228)
		this->audio = ::luxe::Audio_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(229)
		this->input = ::luxe::Input_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(230)
		this->physics = ::luxe::Physics_obj::__new(hx::ObjectPtr<OBJ_>(this));
		HX_STACK_LINE(233)
		this->resources = ::luxe::resource::ResourceManager_obj::__new();
		HX_STACK_LINE(234)
		...
		if ((!(this->headless))){
			...
			HX_STACK_LINE(243)
			this->renderer = ::phoenix::Renderer_obj::__new(hx::ObjectPtr<OBJ_>(this));
			HX_STACK_LINE(245)
		...
		HX_STACK_LINE(259)
		this->screen = ::luxe::Screen_obj::__new(hx::ObjectPtr<OBJ_>(this),(int)0,(int)0,_window_w,_window_h);
		HX_STACK_LINE(264)
		this->debug->init();
		HX_STACK_LINE(265)
		this->timer->init();
		...
		if ((!(this->headless))){
			struct _Function_2_1{
				inline static Dynamic Block( ::luxe::Core_obj *__this){
			...
			HX_STACK_LINE(282)
			::Luxe_obj::camera = ::luxe::Camera_obj::__new(_Function_2_1::Block(this));
		}
		HX_STACK_LINE(285)
		::Luxe_obj::physics = this->physics;
		HX_STACK_LINE(287)
		this->scene = ::luxe::Scene_obj::__new(HX_CSTRING("default scene"));
		HX_STACK_LINE(288)
...
Void Core_obj::window_event( Dynamic _event){
{
		...
		{
			HX_STACK_LINE(401)
			int _g = _event->__Field(HX_CSTRING("type"),true);		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(401)
			switch( (int)(_g)){
				case (int)5: {
					HX_STACK_LINE(404)
...
Void Core_obj::oninputdown( ::String name,Dynamic event){
{
		...
		if ((!(this->shutting_down))){
			...
			HX_STACK_LINE(575)
			Dynamic _g = _Function_2_1::Block(event,name);		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(575)
			this->emitter->emit(HX_CSTRING("inputdown"),_g,hx::SourceInfo(HX_CSTRING("Core.hx"),575,HX_CSTRING("luxe.Core"),HX_CSTRING("oninputdown")));
			HX_STACK_LINE(577)
...
Void Core_obj::oninputup( ::String name,Dynamic event){
{
		...
		if ((!(this->shutting_down))){
			...
			Dynamic _g = _Function_2_1::Block(event,name);		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(587)
			this->emitter->emit(HX_CSTRING("inputup"),_g,hx::SourceInfo(HX_CSTRING("Core.hx"),587,HX_CSTRING("luxe.Core"),HX_CSTRING("oninputup")));
			HX_STACK_LINE(589)
...
Void Core_obj::onmousedown( int x,int y,int button,Float timestamp,int window_id){
{
		...
		HX_STACK_ARG(window_id,"window_id")
		HX_STACK_LINE(600)
		this->_mouse_pos = ::phoenix::Vector_obj::__new(x,y,null(),null());
		HX_STACK_LINE(601)
		::Luxe_obj::mouse = this->_mouse_pos;
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::Core_obj *__this,Float &timestamp,int &button,int &x,int &window_id,int &y){
...
Void Core_obj::onmousemove( int x,int y,int xrel,int yrel,Float timestamp,int window_id){
{
		...
		::Luxe_obj::mouse = this->_mouse_pos;
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::Core_obj *__this,Float &timestamp,int &yrel,int &xrel,int &x,int &window_id,int &y){
...
Void Core_obj::onmousewheel( int x,int y,Float timestamp,int window_id){
{
		...
		HX_STACK_ARG(window_id,"window_id")
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::Core_obj *__this,Float &timestamp,int &x,int &window_id,int &y){
...
Void Core_obj::ontouchdown( Float x,Float y,int touch_id,Float timestamp){
{
		...
		HX_STACK_ARG(timestamp,"timestamp")
		HX_STACK_LINE(706)
		this->_touch_pos = ::phoenix::Vector_obj::__new(x,y,null(),null());
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::Core_obj *__this,Float &timestamp,Float &x,int &touch_id,Float &y){
...
Void Core_obj::ontouchmove( Float x,Float y,Float dx,Float dy,int touch_id,Float timestamp){
{
		...
		this->_touch_pos = ::phoenix::Vector_obj::__new(x,y,null(),null());
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::Core_obj *__this,Float &timestamp,Float &dy,Float &x,Float &dx,int &touch_id,Float &y){
...
Void Core_obj::process_loading_thread( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(899)
		this->thread_message = ::cpp::vm::Thread_obj::readMessage(false);
		HX_STACK_LINE(901)
