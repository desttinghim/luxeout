...
HX_STACK_ARG(_options,"_options")
{
	...
	HX_STACK_LINE(128)
	this->_components = ::luxe::components::Components_obj::__new(hx::ObjectPtr<OBJ_>(this));
	HX_STACK_LINE(129)
	...
	if (((this->options != null()))){
		...
		if (((this->options->__Field(HX_CSTRING("pos"),true) != null()))){
			...
			HX_STACK_LINE(158)
			this->set_pos(::phoenix::Vector_obj::__new(_op->x,_op->y,_op->z,_op->w));
		}
		HX_STACK_LINE(161)
		if (((this->options->__Field(HX_CSTRING("scale"),true) != null()))){
			...
			HX_STACK_LINE(163)
			this->set_scale(::phoenix::Vector_obj::__new(_os->x,_os->y,_os->z,_os->w));
		}
		HX_STACK_LINE(170)
...
Void Entity_obj::_init( ){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::Entity_obj *__this){
...
;
		...
		this->ondestroy();
		HX_STACK_LINE(342)
		if (((  (((this->get_parent() != null()))) ? bool(!(_from_parent)) : bool(false) ))){
			HX_STACK_LINE(344)
				...
				if ((!(_this->dirty))){
					...
					if (((_this->parent != null()))){
						...
						if (((_m != null()))){
							...
							HX_STACK_LINE(385)
							_this1->floats = ::snow::platform::native::utils::Float32Array_obj::__new(_this2->_float32array,null(),null());
						}
						HX_STACK_LINE(385)
						_this1->matrix;
					}
						...
						if ((_this1->auto_decompose)){
							...
							HX_STACK_LINE(385)
							{
								...
								if (((_this2->_transform == null()))){
									HX_STACK_LINE(385)
									_this2->_transform = ::phoenix::MatrixTransform_obj::__new(_position,_quaternion,_scale);
								}
								else{
									HX_STACK_LINE(385)
...
{
		HX_STACK_FRAME("luxe.Entity","_detach_scene",0xe66c124c,"luxe.Entity._detach_scene","luxe/Entity.hx",494,0x55caa482)
		HX_STACK_THIS(this)
		HX_STACK_LINE(494)
		if (((this->get_scene() != null()))){
			HX_STACK_LINE(496)
...
{
		HX_STACK_FRAME("luxe.Entity","_attach_scene",0xae36123e,"luxe.Entity._attach_scene","luxe/Entity.hx",523,0x55caa482)
		HX_STACK_THIS(this)
		HX_STACK_LINE(523)
		if (((this->get_scene() != null()))){
			HX_STACK_LINE(524)
...
Void Entity_obj::_set_fixed_rate_timer( Float _rate,Dynamic _pos){
{
		...
		this->_stop_fixed_rate_timer();
		HX_STACK_LINE(785)
		if (((  (((  (((_rate != (int)0))) ? bool((this->get_parent() == null())) : bool(false) ))) ? bool(!(this->destroyed)) : bool(false) ))){
			HX_STACK_LINE(786)
			this->fixed_rate_timer = ::snow::utils::Timer_obj::__new(_rate);
			HX_STACK_LINE(787)
