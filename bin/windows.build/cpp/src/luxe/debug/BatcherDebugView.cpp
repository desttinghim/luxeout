...
{
		HX_STACK_FRAME("luxe.debug.BatcherDebugView","create",0x7eca9926,"luxe.debug.BatcherDebugView.create","luxe/debug/BatcherDebugView.hx",22,0xdc49bab8)
		HX_STACK_THIS(this)
		struct _Function_1_1{
			inline static Dynamic Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/BatcherDebugView.hx",22,0xdc49bab8)
				{
					...
					__result->Add(HX_CSTRING("camera") , ::phoenix::Camera_obj::__new(_Function_2_1::Block()),false);
		...
		HX_STACK_LINE(22)
		this->batcher = ::Luxe_obj::renderer->create_batcher(_Function_1_1::Block());
	}
return null();
}
...
Void BatcherDebugView_obj::onmousedown( Dynamic e){
{
		...
		HX_STACK_LINE(40)
		{
			...
			HX_STACK_LINE(40)
			this->dragmstart = ::phoenix::Vector_obj::__new(_this->x,_this->y,_this->z,_this->w);
		}
		HX_STACK_LINE(41)
		{
			HX_STACK_LINE(41)
			...
			HX_STACK_LINE(41)
			this->dragstart = ::phoenix::Vector_obj::__new(_this->x,_this->y,_this->z,_this->w);
		}
		HX_STACK_LINE(42)
		this->dragging = true;
	}
...
Void BatcherDebugView_obj::onmousemove( Dynamic e){
{
		...
		if ((this->dragging)){
			...
			struct _Function_2_1{
				inline static ::phoenix::Vector Block( ::luxe::debug::BatcherDebugView_obj *__this,::phoenix::Vector &diff){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/BatcherDebugView.hx",50,0xdc49bab8)
					{
						HX_STACK_LINE(50)
						::phoenix::Vector a = __this->dragstart;		HX_STACK_VAR(a,"a");
						HX_STACK_LINE(50)
						return ::phoenix::Vector_obj::__new((a->x - diff->x),(a->y - diff->y),(a->z - diff->z),null());
					}
					return null();
				}
			};
			HX_STACK_LINE(50)
			this->batcher->view->set_pos(_Function_2_1::Block(this,diff));
		}
	}
return null();
}
...
::String BatcherDebugView_obj::keystr( ::phoenix::geometry::GeometryKey key,::phoenix::geometry::GeometryKey key2){
	...
	HX_STACK_LINE(74)
	::String _g = ((((((((HX_CSTRING("ts: ") + key->timestamp) + HX_CSTRING("\n")) + HX_CSTRING("seq: ")) + key->sequence) + HX_CSTRING("\n")) + HX_CSTRING("primitive_type: ")) + ::Std_obj::string(key->primitive_type)) + HX_CSTRING(" "));		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(74)
	::String _g1 = (((_g + ::Std_obj::string(key->primitive_type)) + HX_CSTRING("\n")) + HX_CSTRING("texture: "));		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(74)
	::String _g2;		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(74)
	_g2 = (((_g1 + ((  (((key->texture == null()))) ? ::String(HX_CSTRING("null")) : ::String(::Std_obj::string(key->texture->texture)) ))) + HX_CSTRING("\n")) + HX_CSTRING("texture id: "));
	HX_STACK_LINE(74)
	::String _g3;		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(74)
	_g3 = (((_g2 + ((  (((key->texture == null()))) ? ::String(HX_CSTRING("null")) : ::String(key->texture->id) ))) + HX_CSTRING("\n")) + HX_CSTRING("shader: "));
	HX_STACK_LINE(74)
	::String _g4;		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(74)
	_g4 = (((((((((_g3 + ((  (((key->shader == null()))) ? ::String(HX_CSTRING("null")) : ::String(key->shader->id) ))) + HX_CSTRING("\n")) + HX_CSTRING("group: ")) + key->group) + HX_CSTRING("\n")) + HX_CSTRING("depth: ")) + key->depth) + HX_CSTRING("\n")) + HX_CSTRING("clip: "));
	HX_STACK_LINE(74)
	return (_g4 + ::Std_obj::string(key->clip));
}
	...
	HX_STACK_ARG(_bbw,"_bbw")
{
		...
		if ((_g->dropped)){
			HX_STACK_LINE(96)
			c = ::phoenix::Color_obj::__new((int)1,(int)1,(int)1,(int)1)->rgb((int)13369344);
		}
		struct _Function_1_1{
			inline static Dynamic Block( Float &_bh,::luxe::debug::BatcherDebugView_obj *__this,::phoenix::Color &c,Float &_bwhalf,Float &_bw,::phoenix::Vector &_p){
		...
		HX_STACK_LINE(99)
		this->_tree_geom->add_geometry(::Luxe_obj::draw->rectangle(_Function_1_1::Block(_bh,this,c,_bwhalf,_bw,_p)));
		HX_STACK_LINE(113)
		::phoenix::Rectangle _g1 = ::phoenix::Rectangle_obj::__new((_p->x - _bwhalf),_p->y,_bw,_bh);		HX_STACK_VAR(_g1,"_g1");
		struct _Function_1_2{
			inline static Dynamic Block( ::luxe::debug::BatcherDebugView_obj *__this,::phoenix::Rectangle &_g1,::phoenix::Color &c,::luxe::structural::BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry &_leaf,::phoenix::geometry::Geometry &_g){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/BatcherDebugView.hx",111,0xdc49bab8)
				{
					...
					__result->Add(HX_CSTRING("batcher") , __this->batcher,false);
					__result->Add(HX_CSTRING("depth") , 999.4,false);
					__result->Add(HX_CSTRING("text") , __this->keystr(_leaf->key,_g->key),false);
		...
		HX_STACK_LINE(110)
		this->_tree_geom->add_geometry(::Luxe_obj::draw->text(_Function_1_2::Block(this,_g1,c,_leaf,_g)));
		HX_STACK_LINE(124)
		...
		struct _Function_1_3{
			inline static Dynamic Block( ::luxe::debug::BatcherDebugView_obj *__this,::phoenix::Color &c,::phoenix::geometry::Geometry &_g,::phoenix::Vector &t,int &talign){
		...
		HX_STACK_LINE(132)
		this->_tree_geom->add_geometry(::Luxe_obj::draw->text(_Function_1_3::Block(this,c,_g,t,talign)));
		HX_STACK_LINE(145)
		...
		if (((_leaf->left != null()))){
			...
			HX_STACK_LINE(152)
			notes_l = ::Luxe_obj::renderer->batcher->compare_rule_to_string(compare);
		}
		HX_STACK_LINE(155)
		if (((_leaf->right != null()))){
			HX_STACK_LINE(156)
			...
			HX_STACK_LINE(158)
			notes_r = ::Luxe_obj::renderer->batcher->compare_rule_to_string(compare);
		}
		struct _Function_1_4{
			inline static Dynamic Block( ::luxe::debug::BatcherDebugView_obj *__this,::phoenix::Color &c2,::phoenix::Vector &t2,int &talign,::String &notes_l,::String &notes_r){
		...
		HX_STACK_LINE(161)
		this->_tree_geom->add_geometry(::Luxe_obj::draw->text(_Function_1_4::Block(this,c2,t2,talign,notes_l,notes_r)));
	}
return null();
}
...
Void BatcherDebugView_obj::draw_geom_leaf( bool L,::luxe::structural::BalancedBSTNode_phoenix_geometry_GeometryKey_phoenix_geometry_Geometry _leaf,::phoenix::Vector _p){
{
		...
		if (((_leaf != null()))){
			...
			if (((_leaf->left != null()))){
				HX_STACK_LINE(195)
				if (((::Luxe_obj::renderer->batcher->geometry_compare(_leaf->left->key,_leaf->key) < (int)0))){
					HX_STACK_LINE(196)
					c = ::phoenix::Color_obj::__new((int)1,(int)1,(int)1,(int)1)->rgb((int)52224);
				}
				else{
					HX_STACK_LINE(198)
					c = ::phoenix::Color_obj::__new((int)1,(int)1,(int)1,(int)1)->rgb((int)13369344);
				...
				HX_STACK_LINE(204)
				::phoenix::Vector _g = ::phoenix::Vector_obj::__new((_p->x - _bwhalf),(_p->y + _bh),null(),null());		HX_STACK_VAR(_g,"_g");
				struct _Function_3_1{
					inline static Dynamic Block( ::luxe::debug::BatcherDebugView_obj *__this,Float &_bwb,::phoenix::Color &c,Float &_bh2,::phoenix::Vector &_g,::phoenix::Vector &_p){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/BatcherDebugView.hx",202,0xdc49bab8)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							__result->Add(HX_CSTRING("immediate") , __this->as_immediate,false);
							__result->Add(HX_CSTRING("p0") , _g,false);
							__result->Add(HX_CSTRING("p1") , ::phoenix::Vector_obj::__new((_p->x - _bwb),(_p->y + _bh2),null(),null()),false);
							__result->Add(HX_CSTRING("color") , c,false);
							__result->Add(HX_CSTRING("batcher") , __this->batcher,false);
							__result->Add(HX_CSTRING("depth") , 999.4,false);
							return __result;
				...
				HX_STACK_LINE(201)
				this->_tree_geom->add_geometry(::Luxe_obj::draw->line(_Function_3_1::Block(this,_bwb,c,_bh2,_g,_p)));
				HX_STACK_LINE(212)
				this->draw_geom_leaf(true,_leaf->left,::phoenix::Vector_obj::__new((_p->x - _bwb),(_p->y + _bh2),null(),null()));
			}
			HX_STACK_LINE(214)
			if (((_leaf->right != null()))){
				HX_STACK_LINE(216)
				if (((::Luxe_obj::renderer->batcher->geometry_compare(_leaf->right->key,_leaf->key) > (int)0))){
					HX_STACK_LINE(217)
					c = ::phoenix::Color_obj::__new((int)1,(int)1,(int)1,(int)1)->rgb((int)52224);
				}
				else{
				...
				HX_STACK_LINE(225)
				::phoenix::Vector _g1 = ::phoenix::Vector_obj::__new((_p->x + _bwhalf),(_p->y + _bh),null(),null());		HX_STACK_VAR(_g1,"_g1");
				struct _Function_3_1{
					inline static Dynamic Block( ::luxe::debug::BatcherDebugView_obj *__this,::phoenix::Vector &_g1,Float &_bwb,::phoenix::Color &c,Float &_bh2,::phoenix::Vector &_p){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/BatcherDebugView.hx",223,0xdc49bab8)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							__result->Add(HX_CSTRING("immediate") , __this->as_immediate,false);
							__result->Add(HX_CSTRING("p0") , _g1,false);
							__result->Add(HX_CSTRING("p1") , ::phoenix::Vector_obj::__new((_p->x + _bwb),(_p->y + _bh2),null(),null()),false);
							__result->Add(HX_CSTRING("color") , c,false);
							__result->Add(HX_CSTRING("batcher") , __this->batcher,false);
							__result->Add(HX_CSTRING("depth") , 999.4,false);
				...
				HX_STACK_LINE(222)
				this->_tree_geom->add_geometry(::Luxe_obj::draw->line(_Function_3_1::Block(this,_g1,_bwb,c,_bh2,_p)));
				HX_STACK_LINE(233)
				this->draw_geom_leaf(false,_leaf->right,::phoenix::Vector_obj::__new((_p->x + _bwb),(_p->y + _bh2),null(),null()));
			}
		}
	}
return null();
...
Void BatcherDebugView_obj::draw_batcher_tree( ){
{
		...
		this->_tree_geom = null();
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::debug::BatcherDebugView_obj *__this){
		...
		HX_STACK_LINE(241)
		this->_tree_geom = ::phoenix::geometry::CompositeGeometry_obj::__new(_Function_1_1::Block(this));
		HX_STACK_LINE(248)
