...
{
		HX_STACK_FRAME("luxe.debug.TraceDebugView","on_trace",0xbe5c46ed,"luxe.debug.TraceDebugView.on_trace","luxe/debug/TraceDebugView.hx",25,0x3d0b52d6)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_ARG(inf,"inf")
		HX_STACK_LINE(25)
		this->add_line(((((inf->__Field(HX_CSTRING("fileName"),true) + HX_CSTRING(":")) + inf->__Field(HX_CSTRING("lineNumber"),true)) + HX_CSTRING(" ")) + ::Std_obj::string(v)));
	}
return null();
}
...
Void TraceDebugView_obj::create( ){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::Screen &_g1,::luxe::Debug &debug,::phoenix::Color &_g){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/TraceDebugView.hx",32,0x3d0b52d6)
				{
					...
					__result->Add(HX_CSTRING("bounds") , ::phoenix::Rectangle_obj::__new((debug->padding->x + (int)20),(debug->padding->y + (int)40),((_g1->w - (debug->padding->x * (int)2)) - (int)20),((::Luxe_obj::get_screen()->h - (debug->padding->y * (int)2)) - (int)40)),false);
		...
		HX_STACK_LINE(32)
		this->lines = ::luxe::Text_obj::__new(_Function_1_1::Block(_g1,debug,_g));
		HX_STACK_LINE(47)
