...
Dynamic _max = __o__max.Default(0.0);
{
	...
	this->width = (int)128;
	HX_STACK_LINE(179)
	this->color_red = ::phoenix::Color_obj::__new(null(),null(),null(),null())->rgb((int)13369344);
	HX_STACK_LINE(180)
	this->color_green = ::phoenix::Color_obj::__new(null(),null(),null(),null())->rgb((int)2263108);
	HX_STACK_LINE(181)
	this->color_normal = ::phoenix::Color_obj::__new(null(),null(),null(),null())->rgb((int)15790320);
	HX_STACK_LINE(183)
	if (((_max == 0.0))){
		HX_STACK_LINE(183)
	...
	HX_STACK_LINE(184)
	{
		...
		HX_STACK_LINE(184)
		this->max = (Float(::Std_obj::_int((this->max * n))) / Float(n));
	}
	HX_STACK_LINE(185)
	this->name = _name;
	HX_STACK_LINE(186)
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::phoenix::Color &_color,::luxe::debug::_ProfilerDebugView::ProfilerBar_obj *__this,::String &_name){
	...
	HX_STACK_LINE(189)
	this->text_item = ::luxe::Text_obj::__new(_Function_1_1::Block(_color,this,_name));
	struct _Function_1_2{
		inline static Dynamic Block( ::luxe::debug::_ProfilerDebugView::ProfilerBar_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/ProfilerDebugView.hx",200,0xef83e3c4)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_CSTRING("color") , ::phoenix::Color_obj::__new(null(),null(),null(),null())->rgb((int)592137),false);
				__result->Add(HX_CSTRING("depth") , 999.3,false);
				__result->Add(HX_CSTRING("batcher") , ::Luxe_obj::debug->batcher,false);
	...
	HX_STACK_LINE(200)
	this->bg_geometry = ::Luxe_obj::draw->box(_Function_1_2::Block(this));
	struct _Function_1_3{
		inline static Dynamic Block( ::luxe::debug::_ProfilerDebugView::ProfilerBar_obj *__this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/ProfilerDebugView.hx",207,0xef83e3c4)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_CSTRING("color") , ::phoenix::Color_obj::__new(null(),null(),null(),null())->rgb((int)2236962),false);
				__result->Add(HX_CSTRING("depth") , 999.3,false);
				__result->Add(HX_CSTRING("batcher") , ::Luxe_obj::debug->batcher,false);
				__result->Add(HX_CSTRING("x") , (int)0,false);
				__result->Add(HX_CSTRING("y") , (int)0,false);
	...
	HX_STACK_LINE(207)
	this->graphbg_geometry = ::Luxe_obj::draw->box(_Function_1_3::Block(this));
	struct _Function_1_4{
		inline static Dynamic Block( ::phoenix::Color &_color,::luxe::debug::_ProfilerDebugView::ProfilerBar_obj *__this){
	...
	HX_STACK_LINE(214)
	this->bar_geometry = ::Luxe_obj::draw->box(_Function_1_4::Block(_color,this));
	...
	HX_STACK_LINE(221)
	this->graph_geometry = ::phoenix::geometry::Geometry_obj::__new(_Function_1_5::Block(_color));
	HX_STACK_LINE(227)
	{
		HX_STACK_LINE(227)
		...
		while(((_g1 < _g))){
			...
			HX_STACK_LINE(228)
			::phoenix::geometry::Vertex _b = ::phoenix::geometry::Vertex_obj::__new(::phoenix::Vector_obj::__new((this->segment * i),(int)0,null(),null()),_color,null());		HX_STACK_VAR(_b,"_b");
			HX_STACK_LINE(229)
...
Float ProfilerBar_obj::set_ping( Float _v){
	...
	HX_STACK_LINE(257)
	{
		...
		HX_STACK_LINE(257)
		_vv = (Float(::Std_obj::_int(((_v * (int)1000) * n))) / Float(n));
	}
	HX_STACK_LINE(258)
...
Float ProfilerBar_obj::set_value( Float _v){
	...
	HX_STACK_LINE(309)
	this->bar_geometry->resize(::phoenix::Vector_obj::__new(nx,(this->height - (int)2),null(),null()));
	HX_STACK_LINE(312)
...
::phoenix::Vector ProfilerBar_obj::set_pos( ::phoenix::Vector _p){
	...
	HX_STACK_LINE(318)
	this->text_item->set_pos(::phoenix::Vector_obj::__new(((_p->x + (this->width * (int)2)) + (int)10),(_p->y - (int)6),null(),null()));
	HX_STACK_LINE(319)
	{
		HX_STACK_LINE(319)
