...
Void StatsDebugView_obj::create( ){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::phoenix::Vector &_g1,::luxe::debug::StatsDebugView_obj *__this,::luxe::Debug &debug,::phoenix::Color &_g){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/StatsDebugView.hx",82,0x06813970)
				{
					...
					__result->Add(HX_CSTRING("text") , __this->get_render_stats_string(),false);
		...
		HX_STACK_LINE(82)
		this->render_stats_text = ::luxe::Text_obj::__new(_Function_1_1::Block(_g1,this,debug,_g));
		HX_STACK_LINE(97)
		::phoenix::Color _g2 = ::phoenix::Color_obj::__new((int)0,(int)0,(int)0,(int)1)->rgb((int)16121979);		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(98)
		::phoenix::Vector _g3 = ::phoenix::Vector_obj::__new((debug->padding->x * (int)2),(debug->padding->y * 7.5),null(),null());		HX_STACK_VAR(_g3,"_g3");
		struct _Function_1_2{
			inline static Dynamic Block( ::luxe::debug::StatsDebugView_obj *__this,::luxe::Debug &debug,::phoenix::Color &_g2,::phoenix::Vector &_g3){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/StatsDebugView.hx",94,0x06813970)
				{
					...
					__result->Add(HX_CSTRING("font") , ::Luxe_obj::renderer->font,false);
					__result->Add(HX_CSTRING("text") , __this->get_resource_stats_string(),false);
					__result->Add(HX_CSTRING("point_size") , __this->font_size,false);
					__result->Add(HX_CSTRING("batcher") , debug->batcher,false);
					__result->Add(HX_CSTRING("visible") , false,false);
					return __result;
		...
		HX_STACK_LINE(94)
		this->resource_stats_text = ::luxe::Text_obj::__new(_Function_1_2::Block(this,debug,_g2,_g3));
		HX_STACK_LINE(109)
		::phoenix::Color _g4 = ::phoenix::Color_obj::__new((int)0,(int)0,(int)0,(int)1)->rgb((int)16121979);		HX_STACK_VAR(_g4,"_g4");
		struct _Function_1_3{
			inline static Dynamic Block( ::luxe::debug::StatsDebugView_obj *__this,::luxe::Debug &debug,::phoenix::Color &_g4){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/StatsDebugView.hx",106,0x06813970)
				{
					...
					__result->Add(HX_CSTRING("pos") , ::phoenix::Vector_obj::__new((debug->padding->x * (int)7),(debug->padding->y * (int)3),null(),null()),false);
					__result->Add(HX_CSTRING("font") , ::Luxe_obj::renderer->font,false);
		...
		HX_STACK_LINE(106)
		this->resource_list_text = ::luxe::Text_obj::__new(_Function_1_3::Block(this,debug,_g4));
		HX_STACK_LINE(119)
				...
				HX_STACK_LINE(131)
				{
					...
					switch( (int)(_g2->__Index())){
						case (int)4: {
							...
							HX_STACK_LINE(134)
							hx::AddEq(texture_lists,((((((((HX_CSTRING("\t") + t->id) + HX_CSTRING("    (")) + t->width_actual) + HX_CSTRING("x")) + t->height_actual) + HX_CSTRING("  ")) + t->estimated_memory()) + HX_CSTRING(" )\n")));
						}
						;break;
						case (int)7: {
							HX_STACK_LINE(136)
...
Void StatsDebugView_obj::update_render_stats( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(237)
		this->debug_geometry_count = ::Luxe_obj::debug->batcher->geometry->size();
		HX_STACK_LINE(238)
