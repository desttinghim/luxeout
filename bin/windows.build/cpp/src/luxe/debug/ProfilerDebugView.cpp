...
HX_STACK_FRAME("luxe.debug.ProfilerDebugView","new",0x4a00bf2e,"luxe.debug.ProfilerDebugView.new","luxe/debug/ProfilerDebugView.hx",12,0xef83e3c4)
{
	...
	HX_STACK_LINE(21)
	::luxe::debug::ProfilerDebugView_obj::lists = ::haxe::ds::StringMap_obj::__new();
}
;
	return null();
}
...
Void ProfilerDebugView_obj::add_offset( ::String _id,::String _offset){
{
		...
		if (((bool((_item != null())) && bool((_offsetitem != null()))))){
			...
			HX_STACK_LINE(33)
			::String _g = (::Std_obj::string(_item) + HX_CSTRING(" / "));		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(33)
			::String _g1 = (_g + ::Std_obj::string(_offsetitem));		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(33)
			::haxe::Log_obj::trace(_g1,hx::SourceInfo(HX_CSTRING("ProfilerDebugView.hx"),33,HX_CSTRING("luxe.debug.ProfilerDebugView"),HX_CSTRING("add_offset")));
		}
	}
return null();
}
	...
	HX_STACK_ARG(_max,"_max")
{
		...
		if (((_item == null()))){
			HX_STACK_LINE(56)
			_item = ::luxe::debug::_ProfilerDebugView::ProfilerValue_obj::__new(_id,::luxe::debug::_ProfilerDebugView::ProfilerBar_obj::__new(_id,_max,::phoenix::Color_obj::__new(null(),null(),null(),null())->rgb((int)16121979)));
			HX_STACK_LINE(57)
			_item->bar->set_pos(::phoenix::Vector_obj::__new((::Luxe_obj::debug->padding->x * (int)2),((::Luxe_obj::debug->padding->y * (int)3) + (::Lambda_obj::count(::luxe::debug::ProfilerDebugView_obj::lists,null()) * (int)20)),null(),null()));
			HX_STACK_LINE(58)
			::luxe::debug::ProfilerDebugView_obj::lists->set(_id,_item);
		}
		HX_STACK_LINE(61)
		_item->start = ::Luxe_obj::get_time();
	}
return null();
}
