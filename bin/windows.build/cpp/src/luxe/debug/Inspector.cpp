...
HX_STACK_ARG(_options,"_options")
{
	...
	HX_STACK_LINE(40)
	this->set_size(::phoenix::Vector_obj::__new(_g,::Std_obj::_int((::Luxe_obj::get_screen()->h * 0.6)),null(),null()));
	HX_STACK_LINE(41)
	::luxe::Screen _g1 = ::Luxe_obj::get_screen();		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(41)
	this->pos = ::phoenix::Vector_obj::__new(((Float(_g1->w) / Float((int)2)) - (Float(this->size->x) / Float((int)2))),((Float(::Luxe_obj::get_screen()->h) / Float((int)2)) - (Float(this->size->y) / Float((int)2))),null(),null());
	HX_STACK_LINE(44)
	this->uitexture = ::phoenix::Texture_obj::load_from_resource(HX_CSTRING("tiny.ui.png"),null());
	HX_STACK_LINE(45)
	this->uibutton = ::phoenix::Texture_obj::load_from_resource(HX_CSTRING("tiny.button.png"),null());
	HX_STACK_LINE(48)
...
Void Inspector_obj::_create_window( ){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::luxe::debug::Inspector_obj *__this){
		...
		HX_STACK_LINE(100)
		this->_window = ::luxe::NineSlice_obj::__new(_Function_1_1::Block(this));
		HX_STACK_LINE(106)
		...
		struct _Function_1_2{
			inline static Dynamic Block( ::luxe::debug::Inspector_obj *__this,::phoenix::Color &_g){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/Inspector.hx",112,0x41b2cfbc)
				{
					...
					__result->Add(HX_CSTRING("pos") , ::phoenix::Vector_obj::__new((__this->pos->x + (int)14),(__this->pos->y + (int)6),null(),null()),false);
		...
		HX_STACK_LINE(112)
		this->_title_text = ::luxe::Text_obj::__new(_Function_1_2::Block(this,_g));
		HX_STACK_LINE(131)
		::phoenix::Color _g1 = ::phoenix::Color_obj::__new(null(),null(),null(),null())->rgb((int)3355443);		HX_STACK_VAR(_g1,"_g1");
		struct _Function_1_3{
			inline static Dynamic Block( ::luxe::debug::Inspector_obj *__this,::phoenix::Color &_g1){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","luxe/debug/Inspector.hx",126,0x41b2cfbc)
				{
					...
					__result->Add(HX_CSTRING("pos") , ::phoenix::Vector_obj::__new((__this->pos->x + ((__this->size->x - (int)14))),(__this->pos->y + (int)6),null(),null()),false);
		...
		HX_STACK_LINE(126)
		this->_version_text = ::luxe::Text_obj::__new(_Function_1_3::Block(this,_g1));
		HX_STACK_LINE(140)
