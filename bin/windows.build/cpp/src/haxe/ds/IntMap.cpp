...
{
HX_STACK_FRAME("haxe.ds.IntMap","new",0x7222c4b6,"haxe.ds.IntMap.new","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",29,0x604d6034)
{
	HX_STACK_LINE(29)
...
{
		HX_STACK_FRAME("haxe.ds.IntMap","set",0x72268ff8,"haxe.ds.IntMap.set","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",33,0x604d6034)
		HX_STACK_THIS(this)
...
bool IntMap_obj::exists( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","exists",0x63ba0346,"haxe.ds.IntMap.exists","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",41,0x604d6034)
	HX_STACK_THIS(this)
...
bool IntMap_obj::remove( Dynamic _tmp_key){
	HX_STACK_FRAME("haxe.ds.IntMap","remove",0xa86281ae,"haxe.ds.IntMap.remove","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",45,0x604d6034)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_tmp_key,"_tmp_key")
	HX_STACK_LINE(45)
	int key = _tmp_key;		HX_STACK_VAR(key,"key");
...
Dynamic IntMap_obj::keys( ){
	HX_STACK_FRAME("haxe.ds.IntMap","keys",0x6a4db8de,"haxe.ds.IntMap.keys","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",48,0x604d6034)
	HX_STACK_THIS(this)
	HX_STACK_LINE(49)
